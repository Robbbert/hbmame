...
void cps_state::main_map(address_map &map) {
	...
	map(0x800018,0x80001f).r(this,FUNC(cps_state::cps1_hack_dsw_r));  // HBMAME           /* System input ports / Dip Switches */
	...
	map(0xf1c000,0xf1c001).r(this,FUNC(cps_state::cps1_in2_r));  /* Player 3 controls (later games) HBMAME */
...
void cps_state::qsound_main_map(address_map &map) {
	...
	map(0x800180,0x800187).w(this,FUNC(cps_state::cps1_soundlatch_w));  /* Sound command HBMAME */
	map(0x800188,0x80018f).w(this,FUNC(cps_state::cps1_soundlatch2_w));  /* Sound timer fade HBMAME */
	map(0x900000,0x92ffff).ram().w(this,FUNC(cps_state::cps1_gfxram_w)).share("gfxram");  /* SF2CE executes code from here */
