...
#include "../mame/dataeast/dec0.cpp"
...
ROM_START( decodemo )
	...
	ROM_REGION( 0x80000, "sprites", ROMREGION_ERASE00 )
...
GAME( 2007, baddudef,     baddudes, baddudes, baddudes, dec0_8751_state, empty_init, ROT0, "Arkatrad", "Bad Dudes vs. Dragonninja (French, 2017-10-29)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, decodemo,     baddudes, baddudes, baddudes, dec0_8751_state, empty_init, ROT0, "Charles Doty", "Demo - Data East", MACHINE_SUPPORTS_SAVE )
