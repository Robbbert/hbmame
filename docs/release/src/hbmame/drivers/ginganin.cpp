...
#include "../mame/jaleco/ginganin.cpp"
...
// Ginga NinkyouDen
GAME( 1987, ginganin01,  ginganin, ginganin, ginganin, ginganin_state, empty_init, ROT0, "Nunimmanse", "Ginga NinkyouDen (Korean)", MACHINE_SUPPORTS_SAVE )
