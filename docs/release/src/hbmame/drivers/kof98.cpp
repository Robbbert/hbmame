...
ROM_START( kof98ae0 ) // Anniversary Edition, multiple problems with bad gfx
	ROM_REGION( 0x700000, "maincpu", 0 )
	// These are corrupt during attract mode fight (where cars are driving past), do not use
...
ROM_START( kof98ae1 ) // Anniversary Edition, multiple problems with bad gfx
	ROM_REGION( 0x700000, "maincpu", 0 )
	// These are corrupt during attract mode fight (where cars are driving past), do not use
...
ROM_START( kof98ae2 ) // Anniversary Edition, multiple problems with bad gfx
	ROM_REGION( 0x700000, "maincpu", 0 )
	// These are corrupt during attract mode fight (where cars are driving past), do not use
