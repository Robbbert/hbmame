...
GAME( 2015, nitdsp1,   nitd,     neogeo,   neogeo,  neogeo_class, gfxdec42, ROT0, "hack", "Nightmare in the Dark (Spanish.Rev2)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1996, breaksp,   breakers, neogeo,   neogeo,  neogeo_class, neogeo,   ROT0, "hack", "Breakers (Move change 26c?)", MACHINE_SUPPORTS_SAVE )
