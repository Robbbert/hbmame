...
#include "../mame/konami/pooyan.cpp"

ROM_START( pooytest )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "pooytest.4a",      0x0000, 0x2000, CRC(37b9f6c6) SHA1(685d097d9092b078a041ff6004e879b77f1e8c43) )
...
ROM_START( pooytest2 ) // Hold 2 and hit F3 for diagnostics
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "pooytest2.4a",      0x0000, 0x2000, CRC(a583d5c9) SHA1(9736e62c4fddafe46374abda069f12b492172c6c) )
	ROM_LOAD( "2.5a",         0x2000, 0x2000, CRC(a1463d98) SHA1(b23cc7e61276c61a78e80fe08c7f0c8adadf2ffe) )
	ROM_LOAD( "3.6a",         0x4000, 0x2000, CRC(fe1a9e08) SHA1(5206893760f188ac71a5e6bd42561cf25fcc3d49) )
	ROM_LOAD( "4.7a",         0x6000, 0x2000, CRC(9e0f9bcc) SHA1(4d9707423ad531ac535db432e329b3d52cbb4559) )
...
GAME( 2017, pooytest,  pooyan, pooyan, pooyan, pooyan_state, empty_init, ROT90,  "Shoestring", "Pooyan Test Rom (set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, pooytest2, pooyan, pooyan, pooyan, pooyan_state, empty_init, ROT90,  "Shoestring", "Pooyan Test Rom (set 2)", MACHINE_SUPPORTS_SAVE )
