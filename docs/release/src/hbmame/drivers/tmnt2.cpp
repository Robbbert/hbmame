...
#include "../mame/konami/tmnt2.cpp"

ROM_START( ssriders01 )
...
ROM_START( ssriders02 ) //ssriderseaa
	ROM_REGION( 0xc0000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "064eaa02_s02.8e",   0x000000, 0x40000, CRC(f6bce510) SHA1(3c46487c4bd591fe14248344ac2563beb1437769) )
	ROM_LOAD16_BYTE( "064eaa03_s02.8g",   0x000001, 0x40000, CRC(9e998ebe) SHA1(683d75bcfb8b8f87996fe8aadde4d1c600b409df) )
	ROM_LOAD16_BYTE( "064eaa04_s02.10e",  0x080000, 0x20000, CRC(06755c89) SHA1(0e19d1147407b8062335c0529ae8f7c01b634e01) )
	ROM_LOAD16_BYTE( "064eaa05_s02.10g",  0x080001, 0x20000, CRC(0aad4619) SHA1(98678d79323f5cc439dd186aa45ab3fb2e7d1515) )
...
ROM_START( ssriders03 )
	ROM_REGION( 0xc0000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "064eaa02_s03.8e",   0x000000, 0x40000, CRC(734f4b4c) SHA1(a38d27d38759e3811c54e4921186c91a762eaa62) )
	ROM_LOAD16_BYTE( "064eaa03_s03.8g",   0x000001, 0x40000, CRC(d50e01fd) SHA1(8070090ee0da5e57d6df042da8926dd322629bfd) )
	ROM_LOAD16_BYTE( "064eaa04_s03.10e",  0x080000, 0x20000, CRC(56bb2e75) SHA1(78cf0cc1a529a5f9e37249d8480aa7476e338099) )
	ROM_LOAD16_BYTE( "064eaa05_s02.10g",  0x080001, 0x20000, CRC(0aad4619) SHA1(98678d79323f5cc439dd186aa45ab3fb2e7d1515) )
...
ROM_START( tmnt2s01 )
	...
	ROM_LOAD16_BYTE( "063ada02s01.8e",  0x000000, 0x20000, CRC(651daf6f) SHA1(3abd95fe82566f96efc3f59867504c026b94c5b9) )
	ROM_LOAD16_BYTE( "063ada03s01.8g",  0x000001, 0x20000, CRC(b0011b05) SHA1(d993520bcfce680c3d7a63f530d2bc7c18a3d143) )
...
ROM_START( tmnt2s02 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "063ada02s02.8e",  0x000000, 0x20000, CRC(b29d697d) SHA1(9bbe7859da33450417f14bced76c75b1c5e83092) )
	ROM_LOAD16_BYTE( "063ada03s02.8g",  0x000001, 0x20000, CRC(a633caee) SHA1(4ca8e1f41189d82c68c0759ac1ac354732296fa2) )
	ROM_LOAD16_BYTE( "063ada04.10e", 0x040000, 0x20000, CRC(05ad187a) SHA1(27a36a02ef792d87ffa2364537c42b6c50d6e4f0) )
	ROM_LOAD16_BYTE( "063ada05.10g", 0x040001, 0x20000, CRC(d4826547) SHA1(ffee07be64469fa386a0979352b4fe20c352fee4) )
...
ROM_START( tmnt2s03 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "063ada02s03.8e",  0x000000, 0x20000, CRC(45109177) SHA1(9c264d80e9cabb3529acf5860d7730b4f1cd1bfe) )
	ROM_LOAD16_BYTE( "063ada03s03.8g",  0x000001, 0x20000, CRC(cf50ffc3) SHA1(4e84705582014f264b67a1982dd40930e61479e8) )
	ROM_LOAD16_BYTE( "063ada04.10e", 0x040000, 0x20000, CRC(05ad187a) SHA1(27a36a02ef792d87ffa2364537c42b6c50d6e4f0) )
	ROM_LOAD16_BYTE( "063ada05.10g", 0x040001, 0x20000, CRC(d4826547) SHA1(ffee07be64469fa386a0979352b4fe20c352fee4) )
...
// Sunset Riders
GAME( 2009, ssriders01,     ssriders, ssriders, ssriders,  ssriders_state, empty_init, ROT0,   "Pipi899","Sunset Riders (EX Super Version, 2009-07-28)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, ssriders02,     ssriders, ssriders, ssridr4p,  ssriders_state, empty_init, ROT0,   "hack",  "Sunset Riders (1V4 Edition, 2019-07-28)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, ssriders03,     ssriders, ssriders, ssridr4p,  ssriders_state, empty_init, ROT0,   "hack",  "Sunset Riders (The Hardest Version In Two Weeks, 2019-04-20)", MACHINE_SUPPORTS_SAVE )
// Teenage Mutant Ninja Turtles
GAME( 1991, tmnt2s01,       tmnt2,    tmnt2,    ssrid4ps,  tmnt2_state, empty_init, ROT0,   "hack",  "Teenage Mutant Ninja Turtles (Ex Super Version)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, tmnt2s02,       tmnt2,    tmnt2,    ssrid4ps,  tmnt2_state, empty_init, ROT0,   "hack",  "Teenage Mutant Ninja Turtles (Start Change Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, tmnt2s03,       tmnt2,    tmnt2,    ssrid4ps,  tmnt2_state, empty_init, ROT0,   "hack",  "Teenage Mutant Ninja Turtles (Cowabunga Mode)", MACHINE_SUPPORTS_SAVE )
