...
#include "../mame/williams/williams.cpp"

namespace {

ROM_START( defender2 )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "10",         0xd000, 0x1000, CRC(4d82fc2f) SHA1(b11dc3f3f2100ab14ad5b26cd333b212c454cc8d) )
	ROM_LOAD( "11",         0xe000, 0x1000, CRC(561fad3f) SHA1(597851e78423f30341f682f3fc62bf24cf9e8a91) )
	ROM_LOAD( "12",         0xf000, 0x1000, CRC(836eacca) SHA1(f788fc2a25adffa21e02a3dfe2074e8719405200) )
	...
	ROM_LOAD( "03",         0x2000, 0x1000, CRC(6dd57970) SHA1(1fdee9180bfb835f35ac786116e0f8d7833f2c3f) )
	...
	ROM_LOAD( "07",         0x6000, 0x1000, CRC(55b5b0d2) SHA1(dcf392a899fb6c225c4e31034e242e575c3dc94d) )
	ROM_LOAD( "08",         0x7000, 0x1000, CRC(b4f22d4d) SHA1(2486e895628df9ae1268d9eb2434f240dba99f70) )
	ROM_LOAD( "09",         0x8000, 0x1000, CRC(6df7463d) SHA1(b80c2872fc47b4b604967f176e3931cd992dd692) )
...
ROM_START( sinistar01 ) // balanced ver. First time run gives blank screen, press F3.
	...
	ROM_LOAD( "sinistar01_rom_11.4a", 0xf000, 0x1000, CRC(fe83bce2) SHA1(7774602fbae7c345341be54eb281cf97ead04212) )
	...
	ROM_LOAD( "sinistar01_rom_8.3c",  0x7000, 0x1000, CRC(9b693243) SHA1(04183031598cc4b152b107d583e4f8346a2f60eb) )
	ROM_LOAD( "sinistar01_rom_9.3a",  0x8000, 0x1000, CRC(5ed44beb) SHA1(f77a7d90ebb5e7bf516dbd947aca3b808ff3443d) )
...
ROM_START( splatsc1 )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "splatsc1.10",               0xd000, 0x1000, CRC(6cc2988a) SHA1(bd0648185ab859afc981d4e8ab954ed1f39303e4) )
	ROM_LOAD( "splatsc1.11",               0xe000, 0x1000, CRC(ee960115) SHA1(b3a03b14f7ee97d55b948ecc09c5e4006c31f0ce) )
	ROM_LOAD( "splatsc1.12",               0xf000, 0x1000, CRC(21916fce) SHA1(6896afd10c30d90b807b60f90fced7114b1812e3) )
	...
	ROM_LOAD( "splatsc1.05",               0x4000, 0x1000, CRC(6989e923) SHA1(383d831084cf79e3961125142d1e3bf4fad1ac66) )
	ROM_LOAD( "splatsc1.06",               0x5000, 0x1000, CRC(82b22e55) SHA1(d71c6598f6a43f47f6752c803069efeb877bf1f0) )
	ROM_LOAD( "splatsc1.07",               0x6000, 0x1000, CRC(e0c4230c) SHA1(2795732725f63e766ee23744147bf002373bc5f7) )
	ROM_LOAD( "splatsc1.08",               0x7000, 0x1000, CRC(42ff589f) SHA1(72c9b40c9291a6b97f637c6424265b30227d87c6) )
	ROM_LOAD( "splatsc1.09",               0x8000, 0x1000, CRC(f67564be) SHA1(3fda9032953e4f75df838616d1c7023a1f2e9861) )
...
ROM_START( robotron201 )
	...
	ROM_LOAD( "robotronp.sbb",            0xe000, 0x1000, CRC(e83a2eda) SHA1(4a62fcd2f91dfb609c3d2c300bd9e6cb60edf52e) )
	...
	ROM_LOAD( "robotron201.3",            0x2000, 0x1000, CRC(85eb583e) SHA1(b6c4280415515de6f56b358206dc3bd93a12bfce) )
	ROM_LOAD( "2084_rom_4b_3005-16.e5",   0x3000, 0x1000, CRC(afb1c561) SHA1(aaf89c19fd8f4e8750717169eb1af476aef38a5e) )
	ROM_LOAD( "robotronp.5",              0x4000, 0x1000, CRC(827cb5c9) SHA1(1732d16cd88e0662f1cffce1aeda5c8aa8c31338) )
...
ROM_START( robotrontie )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "robotrontie.a",            0xd000, 0x1000, CRC(952bea55) SHA1(80f51d8e7ec62518afad7e56a47e0756f83f813c) )
	ROM_LOAD( "robotrontie.b",            0xe000, 0x1000, CRC(4c05fd3c) SHA1(0d727458454826fd8222e4022b755d686ccb065f) )
	ROM_LOAD( "2084_rom_12b_3005-24.e7",  0xf000, 0x1000, CRC(645d543e) SHA1(fad7cea868ebf17347c4bc5193d647bbd8f9517b) )
	ROM_LOAD( "2084_rom_1b_3005-13.e4",   0x0000, 0x1000, CRC(66c7d3ef) SHA1(f6d60e26c209c1df2cc01ac07ad5559daa1b7118) )
	ROM_LOAD( "2084_rom_2b_3005-14.c4",   0x1000, 0x1000, CRC(5bc6c614) SHA1(4d6e82bc29f49100f7751ccfc6a9ff35695b84b3) )
	ROM_LOAD( "2084_rom_3b_3005-15.a4",   0x2000, 0x1000, CRC(e99a82be) SHA1(06a8c8dd0b4726eb7f0bb0e89c8533931d75fc1c) )
	ROM_LOAD( "robotrontie.4",            0x3000, 0x1000, CRC(e8238019) SHA1(0ce29f4bf6bdee677c8e80c2d5e66fc556ba349f) )
	ROM_LOAD( "robotronp.5",              0x4000, 0x1000, CRC(827cb5c9) SHA1(1732d16cd88e0662f1cffce1aeda5c8aa8c31338) )
	ROM_LOAD( "2084_rom_6b_3005-18.a5",   0x5000, 0x1000, CRC(bd2c853d) SHA1(f76ec5432a7939b33a27be1c6855e2dbe6d9fdc8) )
	ROM_LOAD( "robotrontie.7",            0x6000, 0x1000, CRC(3ecf4620) SHA1(3c670a1f8df35d18451c82f220a02448bf5ef5ac) )
	ROM_LOAD( "robotrontie.8",            0x7000, 0x1000, CRC(752d7a46) SHA1(85dd58d14d527ca75d6c546d6271bf8ee5a82c8c) )
	ROM_LOAD( "2084_rom_9b_3005-21.a6",   0x8000, 0x1000, CRC(b124367b) SHA1(fd9d75b866f0ebbb723f84889337e6814496a103) )
...
static INPUT_PORTS_START( conquesthb )
	PORT_START("IN0")
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 ) PORT_NAME("Fire")
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP ) PORT_NAME("Thrust")
	PORT_BIT( 0x0c, IP_ACTIVE_HIGH, IPT_CUSTOM ) PORT_CUSTOM_MEMBER(FUNC(conquest_hbmame::read_lower)) // custom handler wants 0-3, which gets upscaled
	...
	PORT_START("IN1")
	PORT_BIT( 0x03, IP_ACTIVE_HIGH, IPT_CUSTOM ) PORT_CUSTOM_MEMBER(FUNC(conquest_hbmame::read_upper))
...
ROM_START( conquesthb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "conquest.b",               0xd000, 0x3000, CRC(9ec28ac4) SHA1(bcf48af66eed3b9e2c0fcd2413fed8167262cfba) )
	ROM_LOAD( "conquest.a",               0x0000, 0x9000, CRC(66e77fe6) SHA1(b2cab7a20ebd29ef07e2bac02eede645f740c584) )
...
GAME( 1982, conquesthb,  0,        williams_b1,      conquesthb,  conquest_hbmame, empty_init, ROT270, "Vid Kidz", "Conquest (prototype)", MACHINE_IS_INCOMPLETE | MACHINE_SUPPORTS_SAVE )
GAME( 1981, defender2,   defender, williams_base,    stargate,    williams_state,  empty_init, ROT0, "Jeff Vavasour", "Defender II", MACHINE_SUPPORTS_SAVE )
GAME( 2024, sinistar01,  sinistar, sinistar_upright, sinistar,    williams_state,  empty_init, ROT270, "Synamax", "Sinistar (balanced ver)", MACHINE_SUPPORTS_SAVE )
GAME( 1982, splatsc1,    splat,    williams_b1,      splat,       williams_state,  empty_init, ROT0, "Williams", "Splat! (sc1 hardware)", MACHINE_SUPPORTS_SAVE )
GAME( 2012, robotron201, robotron, williams_b1,      robotron,    williams_state,  empty_init, ROT0, "Sean Riddle", "Robotron: 2084 (Hacked Patched Blue-201)", MACHINE_SUPPORTS_SAVE )
GAME( 2014, robotronp,   robotron, williams_b1,      robotron,    williams_state,  empty_init, ROT0, "Christian Gingras / Sean Riddle", "Robotron: 2084 (Patched)", MACHINE_SUPPORTS_SAVE )
GAME( 2014, robotrontie, robotron, williams_b1,      robotron,    williams_state,  empty_init, ROT0, "Vid Kidz", "Robotron: 2084 (Tie Die)", MACHINE_SUPPORTS_SAVE )
