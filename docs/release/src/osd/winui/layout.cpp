...
{
	{"All Systems",     "allgames",          FOLDER_ALL,       IDI_FP_ALL,       0,              0,          0,          0, NULL,                       NULL,                    TRUE, OPTIONS_MAX },
	{"Available",       "available",         FOLDER_AVAIL,     IDI_FP_AVAIL,     0,              FI_AVAIL,   0,          0, NULL,                       FilterAvailable,         TRUE, OPTIONS_MAX },
	{"Arcade",          "arcade",            FOLDER_ARCADE,    IDI_FP_ARCADE,    0,              FI_ARCADE,  FI_MESS,    0, NULL,                       DriverIsArcade,          TRUE, OPTIONS_ARCADE },
	{"BIOS",            "bios",              FOLDER_BIOS,      IDI_FP_BIOS,      IDI_FC_BIOS,    0,          0,          0, CreateBIOSFolders,          DriverIsBios,            TRUE, OPTIONS_MAX },
	{"CHD",             "harddisk",          FOLDER_HARDDISK,  IDI_FP_HARDDISK,  0,              0,          0,          0, NULL,                       DriverIsHarddisk,        TRUE, OPTIONS_MAX },
	{"Clones",          "clones",            FOLDER_CLONES,    IDI_FP_CLONES,    0,              FI_CLONES,  FI_PARENTS, 0, NULL,                       DriverIsClone,           TRUE, OPTIONS_MAX },
	{"CPU",             "cpu",               FOLDER_CPU,       IDI_FP_CPU,       IDI_FC_CHIP,    0,          0,          1, CreateCPUFolders,           NULL,                    FALSE, OPTIONS_MAX },
	{"Dumping Status",  "dumping",           FOLDER_DUMP,      IDI_FP_DUMP,      IDI_FC_CHIP,    0,          0,          1, CreateDumpingFolders,       NULL,                    FALSE, OPTIONS_MAX },
	{"FPS",             "fps",               FOLDER_FPS,       IDI_FP_FPS,       IDI_FP_DEF,     0,          0,          1, CreateFPSFolders,           NULL,                    FALSE, OPTIONS_MAX },
	{"Horizontal",      "horizontal",        FOLDER_HORI,      IDI_FP_HORI,      0,              FI_HORI,    FI_VERT,    0, NULL,                       DriverIsVertical,        TRUE, OPTIONS_HORIZONTAL },
	{"Imperfect",       "imperfect",         FOLDER_IMP,       IDI_FP_IMP,       IDI_FP_DEF,     0,          0,          0, CreateDeficiencyFolders,    NULL,                    FALSE, OPTIONS_MAX },
	{"Lightgun",        "lightgun",          FOLDER_LIGHTGUN,  IDI_FP_LIGHTGUN,  0,              0,          0,          0, NULL,                       DriverUsesLightGun,      TRUE, OPTIONS_MAX },
	{"Manufacturer",    "manufacturer",      FOLDER_MANU,      IDI_FP_MANU,      IDI_FC_MANU,    0,          0,          1, CreateManufacturerFolders,  NULL,                    FALSE, OPTIONS_MAX },
	{"Mechanical",      "mechanical",        FOLDER_MECH,      IDI_FP_MECH,      0,              0,          0,          0, NULL,                       DriverIsMechanical,      TRUE, OPTIONS_MAX },
	{"Modified/Hacked", "modified",          FOLDER_MODIFIED,  IDI_FP_MODIFIED,  0,              0,          0,          0, NULL,                       DriverIsModified,        TRUE, OPTIONS_MAX },
	{"Mouse",           "mouse",             FOLDER_MOUSE,     IDI_FP_MOUSE,     0,              0,          0,          0, NULL,                       DriverUsesMouse,         TRUE, OPTIONS_MAX },
	{"Non Mechanical",  "nonmechanical",     FOLDER_NONMECH,   IDI_FP_NONMECH,   0,              0,          0,          0, NULL,                       DriverIsMechanical,      TRUE, OPTIONS_MAX },
	{"Not Working",     "nonworking",        FOLDER_NW,        IDI_FP_NW,        0,              FI_NW,      FI_W,       0, NULL,                       DriverIsBroken,          TRUE, OPTIONS_MAX },
	{"Parents",         "parents",           FOLDER_PARENTS,   IDI_FP_PARENTS,   0,              FI_PARENTS, FI_CLONES,  0, NULL,                       DriverIsClone,           TRUE, OPTIONS_MAX },
//	{"Raster",          "raster",            FOLDER_RASTER,    IDI_FP_RASTER,    0,              FI_RASTER,  FI_VECTOR,  0, NULL,                       DriverIsVector,          TRUE, OPTIONS_RASTER },
	{"Resolution",      "resolution",        FOLDER_RESOL,     IDI_FP_RESOL,     IDI_FP_DEF,     0,          0,          1, CreateResolutionFolders,    NULL,                    FALSE, OPTIONS_MAX },
	{"Samples",         "samples",           FOLDER_SAMPLES,   IDI_FP_SAMPLES,   0,              0,          0,          0, NULL,                       DriverUsesSamples,       TRUE, OPTIONS_MAX },
	{"Save State",      "savestate",         FOLDER_SAVESTATE, IDI_FP_SAVESTATE, 0,              0,          0,          0, CreateSaveStateFolders,     NULL,                    FALSE, OPTIONS_MAX },
	{"Screens",         "screens",           FOLDER_SCREENS,   IDI_FP_MONITOR,   IDI_FC_MONITOR, 0,          0,          1, CreateScreenFolders,        NULL,                    FALSE, OPTIONS_MAX },
	{"Sound",           "sound",             FOLDER_SOUND,     IDI_FP_SOUND,     IDI_FC_SOUND,   0,          0,          1, CreateSoundFolders,         NULL,                    FALSE, OPTIONS_MAX },
	{"Source",          "source",            FOLDER_SOURCE,    IDI_FP_SOURCE,    IDI_FC_SOURCE,  0,          0,          1, CreateSourceFolders,        NULL,                    FALSE, OPTIONS_MAX },
	{"Stereo",          "stereo",            FOLDER_STEREO,    IDI_FP_STEREO,    0,              0,          0,          0, NULL,                       DriverIsStereo,          TRUE, OPTIONS_MAX },
	{"Trackball",       "trackball",         FOLDER_TRACKBALL, IDI_FP_TRACKBALL, 0,              0,          0,          0, NULL,                       DriverUsesTrackball,     TRUE, OPTIONS_MAX },
	{"Unavailable",     "unavailable",       FOLDER_UNAVAIL,   IDI_FP_UNAVAIL,   0,              0,          FI_AVAIL,   0, NULL,                       FilterAvailable,         TRUE, OPTIONS_MAX },
	...
	{"Working",         "working",           FOLDER_W,         IDI_FP_W,         0,              FI_W,       FI_NW,      0, NULL,                       DriverIsBroken,          TRUE, OPTIONS_MAX },
...
extern const FOLDERDATA g_folderData[] =
{
	// Folder Label     Filename (if cached)  Folder Resource  Parent Icon       Child Icon      Filter-in   Filter-out  Cached?  Creation Function       Filter Function        [1]   Name of ini file
	{"All Games",       "allgames",          FOLDER_ALL,       IDI_FP_ALL,       0,              0,          0,          0, NULL,                       NULL,                    TRUE, OPTIONS_MAX },
	{"Available",       "available",         FOLDER_AVAIL,     IDI_FP_AVAIL,     0,              FI_AVAIL,   0,          0, NULL,                       FilterAvailable,         TRUE, OPTIONS_MAX },
	{"BIOS",            "bios",              FOLDER_BIOS,      IDI_FP_BIOS,      IDI_FC_BIOS,    0,          0,          1, CreateBIOSFolders,          DriverIsBios,            TRUE, OPTIONS_MAX },
	{"CHD",             "harddisk",          FOLDER_HARDDISK,  IDI_FP_HARDDISK,  0,              0,          0,          0, NULL,                       DriverIsHarddisk,        TRUE, OPTIONS_MAX },
	{"Clones",          "clones",            FOLDER_CLONES,    IDI_FP_CLONES,    0,              FI_CLONES,  FI_PARENTS, 0, NULL,                       DriverIsClone,           TRUE, OPTIONS_MAX },
	{"CPU",             "cpu",               FOLDER_CPU,       IDI_FP_CPU,       IDI_FC_CHIP,    0,          0,          1, CreateCPUFolders,           NULL,                    FALSE, OPTIONS_MAX },
	{"Dumping Status",  "dumping",           FOLDER_DUMP,      IDI_FP_DUMP,      IDI_FC_CHIP,    0,          0,          1, CreateDumpingFolders,       NULL,                    FALSE, OPTIONS_MAX },
...
//	{"Raster",          "raster",            FOLDER_RASTER,    IDI_FP_RASTER,    0,              FI_RASTER,  FI_VECTOR,  0, NULL,                       DriverIsVector,          FALSE, OPTIONS_RASTER },
	...
	{"Stereo",          "stereo",            FOLDER_STEREO,    IDI_FP_STEREO,    0,              0,          0,          0, NULL,                       DriverIsStereo,          TRUE, OPTIONS_MAX },
	{"Trackball",       "trackball",         FOLDER_TRACKBALL, IDI_FP_TRACKBALL, 0,              0,          0,          0, NULL,                       DriverUsesTrackball,     TRUE, OPTIONS_MAX },
	{"Unavailable",     "unavailable",       FOLDER_UNAVAIL,   IDI_FP_UNAVAIL,   0,              0,          FI_AVAIL,   0, NULL,                       FilterAvailable,         FALSE, OPTIONS_MAX },
	{"Vector",          "vector",            FOLDER_VECTOR,    IDI_FP_VECTOR,    0,              FI_VECTOR,  FI_RASTER,  0, NULL,                       DriverIsVector,          TRUE, OPTIONS_VECTOR },
	{"Vertical",        "vertical",          FOLDER_VERT,      IDI_FP_VERT,      0,              FI_VERT,    FI_HORI,    0, NULL,                       DriverIsVertical,        TRUE, OPTIONS_VERTICAL },
...
#endif
// [1] For folders with child folders, decide if the parent should show anything. Only TRUE for BIOS, and childless folders.
