...
void cclimb_state::cclimber_decode(const uint8_t convtable[8][16])
{
...
void cclimb_state::init_cclimber()
{
...
void cclimb_state::init_cclimberj()
{
	static const uint8_t convtable[8][16] =
	{
...
void cclimb_state::init_cannonb()
{
	uint8_t *rom = memregion("maincpu")->base();
...
void cclimb_state::init_cannonb2()
{
#if CANNONB_HACK
	cannonb_patch(machine());
#endif
