...
#include "../mame/tecmo/bombjack.cpp"
...
GAME( 1984, bombjack01,  bombjack, bombjack, bombjack, bombjack_state, empty_init, ROT90, "hack", "Bomb Jack (Chinese)", MACHINE_SUPPORTS_SAVE )
