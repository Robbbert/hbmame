...
GAME( 1995, sailormnts01,  sailormn, sailormn, cave, cave_state, init_sailormn,  ROT0,   "Gazelle (Banpresto license)(some hack)", "Pretty Soldier Sailor Moon (Ver. 95/03/22B, Taiwan)(some hack)", MACHINE_SUPPORTS_SAVE )
