...
HACK(1981, bbugtest, 0, bbugtest, boxingb, cinemat_hbmame, bbugtest, ORIENTATION_FLIP_Y, "Test Rom", "Test Rom - Boxing Bugs", MACHINE_NO_SOUND_HW | MACHINE_SUPPORTS_SAVE )
