...
ROM_START( sf2cems6a )  /* 920313 USA (this set matches "sf2ceuab4" in FBA) */
	...
	ROM_REGION( 0x600000, "gfx", 0 )
	ROM_LOAD64_WORD( "c14re.c01", 0x000000, 0x80000, CRC(baa0f81f) SHA1(5e55a5c4ad64be17089670a3d73c1c0d9082351b) )  // == sf2ce: s92-1m.3a + s92-2m.4a
	ROM_CONTINUE(               0x000004, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c03", 0x000002, 0x80000, CRC(8edff95a) SHA1(8db35c5940dcc1f09f11be26051b2f98445d10e7) )  // == sf2ce: s92-3m.5a + s92-4m.6a
	ROM_CONTINUE(               0x000006, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c09", 0x200000, 0x80000, CRC(468962b1) SHA1(fdfd2a7cbbcafaa37e972da425446d471e1e1dae) )  // == sf2ce: s92-5m.7a + s92-6m.8a
	ROM_CONTINUE(               0x200004, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c11", 0x200002, 0x80000, CRC(8165f536) SHA1(8178fe2240c73c7283592aa31dd24aec5bf9429b) )  // == sf2ce: s92-7m.9a + s92-8m.10a
	ROM_CONTINUE(               0x200006, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c15", 0x400000, 0x80000, CRC(39d763d3) SHA1(a2a0bddecaca6046785ccddfd20b8356a6ec36f0) )  // == sf2ce: s92-10m.3c + s92-11m.4c
	ROM_CONTINUE(               0x400004, 0x80000 )
	ROM_LOAD64_WORD( "c14ms6a.c17", 0x400002, 0x80000, CRC(2ddfe46e) SHA1(517a76166d387375a75a36b2785de86898bdc777) )  // == sf2ce: s92-12m.5c + s92-13m.6c (1st half differs from s92-12m.5c by 7 bytes, CRC: 19fd3c2d)
	ROM_CONTINUE(               0x400006, 0x80000 )
...
ROM_START( sf2cems6b )  /* 920322 USA */
	...
	ROM_REGION( 0x600000, "gfx", 0 )
	ROM_LOAD64_WORD( "c14re.c01", 0x000000, 0x80000, CRC(baa0f81f) SHA1(5e55a5c4ad64be17089670a3d73c1c0d9082351b) )
	ROM_CONTINUE(               0x000004, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c03", 0x000002, 0x80000, CRC(8edff95a) SHA1(8db35c5940dcc1f09f11be26051b2f98445d10e7) )
	ROM_CONTINUE(               0x000006, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c09", 0x200000, 0x80000, CRC(468962b1) SHA1(fdfd2a7cbbcafaa37e972da425446d471e1e1dae) )
	ROM_CONTINUE(               0x200004, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c11", 0x200002, 0x80000, CRC(8165f536) SHA1(8178fe2240c73c7283592aa31dd24aec5bf9429b) )
	ROM_CONTINUE(               0x200006, 0x80000 )
	ROM_LOAD64_WORD( "c14re.c15", 0x400000, 0x80000, CRC(39d763d3) SHA1(a2a0bddecaca6046785ccddfd20b8356a6ec36f0) )
	ROM_CONTINUE(               0x400004, 0x80000 )
	ROM_LOAD64_WORD( "c14ms6a.c17", 0x400002, 0x80000, CRC(2ddfe46e) SHA1(517a76166d387375a75a36b2785de86898bdc777) )
	ROM_CONTINUE(               0x400006, 0x80000 )
