...
ROM_START( 3wondrud )
	...
	ROM_LOAD_OPTIONAL( "3wondrud.key", 0x000000, 0x000080, CRC(5066be6f) SHA1(a514ffb7561b1d563382c4c69e24c81574902081) )
ROM_END
...
ROM_START( captcoud )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "captcoud.key", 0x000000, 0x000080, CRC(6a4c8ad9) SHA1(56912fc3387cf977e602d3e8dad31b64dadc6b4a) )
ROM_END
...
ROM_START( cps1demo )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "cps1demo.key", 0x000000, 0x000080, CRC(b0e5ee2d) SHA1(8189f48892fff7dc4fff4e765448e0ea2cfba4bc) )
ROM_END
...
ROM_START( cps1frog )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "cps1frog.key", 0x000000, 0x000080, CRC(3adeff30) SHA1(5d242a4e5edcf47905fb50d767d41c2977bfd78b) )
ROM_END
...
ROM_START( cps1tests )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sf2ce.key", 0x000000, 0x000080, CRC(35b37429) SHA1(b372cce106c0900554735c207fb333ac93554ec2) )
ROM_END
...
ROM_START( cps1testm )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "megaman.key", 0x000000, 0x000080, CRC(9c89eb62) SHA1(e67a3ed58f82875cff4861c14bd701b54dcc111f) )
ROM_END
...
ROM_START( daimakb )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "daimakb.key", 0x000000, 0x000080, CRC(c72cad61) SHA1(9036e06c84ff9189a83acd50a703fb6560ce5e98) )
ROM_END
...
ROM_START( dinob ) // program same as dinopic in mame, but this one has working sound
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "dinob.key", 0x000000, 0x000080, CRC(171140c4) SHA1(d1db4e37e22fa6ae03c2bca4fdb698399d98c15f) )
ROM_END
...
ROM_START( dinoex )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "dinoex.key", 0x000000, 0x000080, CRC(6c097c88) SHA1(a8170ace800e96ec29fbef22f5fdc45c7f5b516b) )
ROM_END
...
ROM_START( dinoh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "dinoh.key", 0x000000, 0x000080, CRC(67862673) SHA1(9ae7446231da7fd6355e1f22ac3fb974c3775600) )
ROM_END
...
ROM_START( dinohx )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "dino.key", 0x0000, 0x0080, CRC(61e30e5f) SHA1(994c97e38d1968530c572d9473ac033925dad99e) )
ROM_END
...
ROM_START( ffightb )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "ffightb.key", 0x000000, 0x000080, CRC(328f442c) SHA1(f58a07458f00ee7fdd0471fa03f7859ae9e2629b) )
ROM_END
...
ROM_START( knight21 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "knights.key", 0x000000, 0x000080, CRC(a4851689) SHA1(0a96f22a655c3ff9d09d7b84abd7ab5ac5f137e2) )
ROM_END
...
ROM_START( knightsb2 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "knightsb2.key", 0x000000, 0x000080, CRC(67017a7f) SHA1(d9db5b41b214539f71cc2f0d92a27285c27e38c4) )
ROM_END
...
ROM_START( knightsha )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "knightsha.key", 0x000000, 0x000080, CRC(ab2dff46) SHA1(9bc8ec843ec9e8522858df8fb72e8c0e3fa1f023) )
ROM_END
...
ROM_START( kodh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "kodh.key", 0x000000, 0x000080, CRC(9d65fe9c) SHA1(9671ee388d59a2d12cf38712620f5f598e93abfc) )
ROM_END
...
ROM_START( pnicku )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "pnickj.key", 0x000000, 0x000080, CRC(38afadc4) SHA1(05b49635f99e7cb97a99b9666239d68154cb3641) )
ROM_END
...
ROM_START( punisherb ) // punipic in mame
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "punisherb.key", 0x000000, 0x000080, CRC(e1219963) SHA1(ba508a09095e9a37018a5a8c3a624713d7684582) )
ROM_END
...
ROM_START( punisherud1 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "punisherud1.key", 0x000000, 0x000080, CRC(c22c07f9) SHA1(b726dfed90c288ee71ab6d6035b0efcba1f18f6a) )
ROM_END
...
ROM_START( sf2bhj )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sf2bhj.key", 0x000000, 0x000080, CRC(c62851af) SHA1(2ccc177c433e48e72e7f5dfeeffb65f54239bf12) )
ROM_END
...
ROM_START( sf2c )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sf2c.key", 0x000000, 0x000080, CRC(fdc05d86) SHA1(f828e6171a271bc12a5c9ab5be237562e263ccdb) )
ROM_END
...
ROM_START( sf2h9 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sf2th.key", 0x000000, 0x000080, CRC(67e80fca) SHA1(e937bc4cf0e05ba93c32bc47d65c5b027bc2b48e) )
ROM_END
...
ROM_START( sf2h11 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sf2h11.key", 0x000000, 0x000080, CRC(822729a2) SHA1(acaadef38fd97dba215c13688061cee87d877c19) )
ROM_END
...
ROM_START( sk2h21 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sk2h21.key", 0x000000, 0x000080, CRC(287d8a40) SHA1(46aa717f599f88d32afb5ecc0bf43c2cbe6892d0) )
ROM_END
...
ROM_START( sk2h22 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sk2h31.key", 0x000000, 0x000080, CRC(d741a7b6) SHA1(c7b64e8634945cc8e8f7f508b1bb7ad5ccf95c83) )
ROM_END
...
ROM_START( sk3p1 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "sk3p1.key", 0x000000, 0x000080, CRC(8ac48367) SHA1(aeeab2c3436009d05dd9caa1b1929af4d7e607ae) )
ROM_END
...
ROM_START( slammastud )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "slammastud.key", 0x000000, 0x000080, CRC(ade2c2a3) SHA1(8d7a4249cf221ac24c4c66f7151a9edd7f263de5) )
ROM_END
...
ROM_START( stridergf )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "strider.key", 0x000000, 0x000080, CRC(39065af5) SHA1(ffff84fd87e851718c564062564970677da923c9) )
ROM_END
...
ROM_START( tk2h15 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "wof.key", 0x0000, 0x0080, CRC(522c909c) SHA1(e0d40a36bec025402590caaffcbc4e718748348a) )
ROM_END
...
ROM_START( wofsf2 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD_OPTIONAL( "wofsf2.key", 0x000000, 0x000080, CRC(e4071226) SHA1(a7930d4b069f9d0e6e8510ef394066af5ade6974) )
ROM_END
