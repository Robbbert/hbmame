...
ROM_START( 3wondrud )
	...
	ROM_LOAD( "3wondrud.key", 0x0000, 0x0080, CRC(4005c06b) SHA1(fd9d73c1bfe018b49fce447cfa779a292f18cec0) )
ROM_END
...
ROM_START( captcomc )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "captcomm.key", 0x0000, 0x0080, CRC(dc462ee4) SHA1(de398a59ffcc4163598ff4c740d11e359b798d6b) )
ROM_END
...
ROM_START( captcomh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "captcomm.key", 0x0000, 0x0080, CRC(dc462ee4) SHA1(de398a59ffcc4163598ff4c740d11e359b798d6b) )ROM_END
...
ROM_START( captcoud )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "captcoud.key", 0x0000, 0x0080, CRC(4e6f6620) SHA1(408dff4f75dccd0d0d61802e885e1f7580831fea) )
ROM_END
...
ROM_START( cps1demo )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "cps1demo.key", 0x0000, 0x0080, CRC(ff591da1) SHA1(e57092f2ed84225b2e5a56acc792b50b3fccbabb) )
ROM_END
...
ROM_START( cps1frog )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "cps1frog.key", 0x0000, 0x0080, CRC(9cd54a69) SHA1(b7c405cd1acc4024498bfd803e06d4d027d5fdfd) )
ROM_END
...
ROM_START( cps1test )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sf2ce.key", 0x0000, 0x0080, CRC(f38d6bc2) SHA1(ca30eb2e878193881b6227feeaef05c1849e9757) )
ROM_END
...
ROM_START( cps1testa )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "megaman.key", 0x0000, 0x0080, CRC(122ac945) SHA1(af201bb41e34fb5098e3fbe0c6bc320ef676cd80) )
ROM_END
...
ROM_START( daimakb )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "daimakb.key", 0x0000, 0x0080, CRC(429174f3) SHA1(95be267899eda4bd572cb952baee34fd7fcb2f3c) )
ROM_END
...
ROM_START( dinob ) // program same as dinopic in mame, but this one has working sound
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "dinob.key", 0x0000, 0x0080, CRC(36bfa154) SHA1(e9c9a4887bd97372547d92de5c34bc1e050c218c) )
ROM_END
...
ROM_START( dinoex )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "dinoex.key", 0x0000, 0x0080, CRC(520542b4) SHA1(92a977cb309cd547273bf4310b24ff1742af1e23) )
ROM_END
...
ROM_START( dinoh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "dinoh.key", 0x0000, 0x0080, CRC(7861e67a) SHA1(9f49151b7a40f7d38bf1a1751ac96a73dc862dc5) )
ROM_END
...
ROM_START( ffightb )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "ffightb.key", 0x0000, 0x0080, CRC(4a09ea37) SHA1(d5c504d4c06b1ca89196b3a3cf9dfbe3ae73447c) )
ROM_END
...
ROM_START( knight21 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "knights.key", 0x0000, 0x0080, CRC(3e61082f) SHA1(6c59185398bfd81ba414e84c3439f084ad2500ed) )
ROM_END
...
ROM_START( knightsb2 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "knightsb2.key", 0x0000, 0x0080, CRC(6a7cdb6a) SHA1(8bc2a856fd3b69e9b7079959b5575e55e0fa4168) )
ROM_END
...
ROM_START( knightsh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "knightsh.key", 0x0000, 0x0080, CRC(6b022172) SHA1(a5e86d571be084b1ba9a21d4f07215fdd67c37cc) )
ROM_END
...
ROM_START( knightsha )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "knightsha.key", 0x0000, 0x0080, CRC(35b57fe7) SHA1(a2b6ca400ec0d6696951c44bad28259c2e10ea37) )
ROM_END
...
ROM_START( kodh )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "kodh.key", 0x0000, 0x0080, CRC(482efa4b) SHA1(5637b2990c239a5f7a20794d99f034c62c9d997b) )
ROM_END
...
ROM_START( kodsp )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "kod.key", 0x0000, 0x0080, CRC(18ab233c) SHA1(078ce49afdb0783f703a67c390b38e327af2d507) )
ROM_END
...
ROM_START( pnicku )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "pnickj.key", 0x0000, 0x0080, CRC(2d3be9de) SHA1(58b4cbc81b191b13bf1fae5980ec1dbe091d76ef) )
ROM_END
...
ROM_START( punisherb ) // punipic in mame
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "punisherb.key", 0x0000, 0x0080, CRC(4371be88) SHA1(586ca49c5493cd048f3047b175c640142c176334) )
ROM_END
...
ROM_START( punisherf )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "punisherjh.key", 0x0000, 0x0080, CRC(cacd2dde) SHA1(096a9cc51b64185e4a40b24c828086c36794cb79) )
ROM_END
...
ROM_START( punisherud1 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "punisherud1.key", 0x0000, 0x0080, CRC(75a92665) SHA1(66a0415d1282b03479b725858742021e8b263fb6) )
ROM_END
...
ROM_START( sf2bhj )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sf2bhj.key", 0x0000, 0x0080, CRC(39c4ef09) SHA1(5df2ec65b457215fdbf40bc3476dcc476bec1d61) )
ROM_END
...
ROM_START( sf2c )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sf2c.key", 0x0000, 0x0080, CRC(d7169ced) SHA1(aa6e77cd4f050297f04ad2115b5a04ea82ecf4d6) )
ROM_END
...
ROM_START( sf2h9 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sf2th.key", 0x0000, 0x0080, CRC(cadc837b) SHA1(cb0825f978d628ec537298ccb7acc7fa82a2b94c) )
ROM_END
...
ROM_START( sf2h11 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sf2h11.key", 0x0000, 0x0080, CRC(92fb5350) SHA1(acc15fc721cc3efd6c1572628fe2f22549cf1a92) )
ROM_END
...
ROM_START( sk2h1 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk2h1.key", 0x0000, 0x0080, CRC(a210456d) SHA1(be6c95bc60d13fc23c96d008bfeecd3959b8773d) )
ROM_END
...
ROM_START( sk2h11 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk2h11.key", 0x0000, 0x0080, CRC(ed9ad80e) SHA1(12b6db684f68a8b04a4189a13ad8fbf249358a8a) )
ROM_END
...
ROM_START( sk2h21 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk2h21.key", 0x0000, 0x0080, CRC(c7fe7cc0) SHA1(9345f7c659ea91e178a6dd1a2f6b0d18ef992e5f) )
ROM_END
...
ROM_START( sk2h22 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk2h31.key", 0x0000, 0x0080, CRC(8874e1a3) SHA1(928ec55f9ff1778b37318850f6de3d614b2d8c0b) )
ROM_END
...
ROM_START( sk2h35 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk2h35.key", 0x0000, 0x0080, CRC(c7fe7cc0) SHA1(9345f7c659ea91e178a6dd1a2f6b0d18ef992e5f) )
ROM_END
...
ROM_START( sk3p1 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "sk3p1.key", 0x0000, 0x0080, CRC(625670a2) SHA1(2c34c4ef5510f626e6b6d7bfde5b868be595ae4e) )
ROM_END
...
ROM_START( sk3p2 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "wofch.key", 0x0000, 0x0080, CRC(ed9ad80e) SHA1(12b6db684f68a8b04a4189a13ad8fbf249358a8a) )
ROM_END
...
ROM_START( slammastud )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "slammastud.key", 0x0000, 0x0080, CRC(fe78504a) SHA1(f725a9da6e2e26cbb00ea655c2fb16b9b73b1f56) )
ROM_END
...
ROM_START( stridergf )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "strider.key", 0x0000, 0x0080, CRC(b50d0959) SHA1(bbeed245882f05d8bc4b45f7ef42a6beb93ab810) )
ROM_END
...
ROM_START( wofsf2 )
	...
	ROM_REGION( 0x80, "control", 0 )
	ROM_LOAD( "wofsf2.key", 0x0000, 0x0080, CRC(78483452) SHA1(76c3342ee80d2b84710b0e832044bc47b8987b04) )
ROM_END
