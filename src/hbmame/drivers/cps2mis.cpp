...
ROM_START( sfz3mix ) // 0.11
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.03", 0x000000, 0x80000, CRC(c576f39a) SHA1(db535febc78b0ee17aaf0e11970ce3af595220e5) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.04", 0x080000, 0x80000, CRC(d1c963ad) SHA1(d293d6a6096d3e207747d7e838082f8014db2e91) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.05", 0x100000, 0x80000, CRC(29df08bf) SHA1(e2fbdc78e37010fe4dc2576a318948ec88b85193) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.06", 0x180000, 0x80000, CRC(fc18d833) SHA1(d668915c12b438776d9644d74ac2fb75119a99a7) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.07", 0x200000, 0x80000, CRC(67b83490) SHA1(f70886e7a88e0a4a1a17b022083b67bea9515351) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.08", 0x280000, 0x80000, CRC(6da03096) SHA1(f943cc2e1853cfdc1e36bb6ce04c44c77386f55b) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.09", 0x300000, 0x80000, CRC(3f008ce0) SHA1(e58e9289d2c08c00f68d888e8263daa950b60855) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.10", 0x380000, 0x80000, CRC(11d9171e) SHA1(7ce1f8c5d89f46c559e7b6332901632d2c0ee696) )

	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "sfz3mix.13", 0x0000000, 0x400000, CRC(93183516) SHA1(a4435cf5d384294dc5f85325b8f47f166020fe7b) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.15", 0x0000002, 0x400000, CRC(b06f14ce) SHA1(f653f8c10157102426430670f557d8fc2e0c70ec) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.17", 0x0000004, 0x400000, CRC(661c1355) SHA1(4d53b8bbc466d947320c8c12bdff72b01493c20b) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.19", 0x0000006, 0x400000, CRC(7227f353) SHA1(343534f1679858fae27970a859d54c6e46d16748) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix10.14", 0x1000000, 0x400000, CRC(62496779) SHA1(8534226cc1074097fce296ec1ab6e453f9a2b69d) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix10.16", 0x1000002, 0x400000, CRC(1e7aa3cb) SHA1(66bfe1d7897f9dfd02db0523e8296aa50f4cf8c5) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix10.18", 0x1000004, 0x400000, CRC(95e161ce) SHA1(ef863b415fe4f07f5acf1e5082378c7603d8e58c) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix10.20", 0x1000006, 0x400000, CRC(a6afdc2d) SHA1(6bfd7261246f19cc12364fe02ba090d456a482ce) , ROM_GROUPWORD | ROM_SKIP(6) )
...
GAME( 2022, sfz3mix,    sfa3,     cps2,      cps2_2p6b, cps2_state, init_cps2, ROT0, "Zero800", "Street Fighter Zero 3 (Mix 0.11)", MACHINE_SUPPORTS_SAVE )
