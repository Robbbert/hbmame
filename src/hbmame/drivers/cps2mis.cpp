...
ROM_START( sfz3mix ) // 0.10
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.03", 0x000000, 0x80000, CRC(12ee6b5a) SHA1(ca8551b750a64a6bd65fb13525428af3f6e89634) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.04", 0x080000, 0x80000, CRC(56aab557) SHA1(73b8e200c05ba8d4bceab10c3640826215040f21) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.05", 0x100000, 0x80000, CRC(d6118829) SHA1(30af1347bea9bad71f9404218fb1009178346f6b) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.06", 0x180000, 0x80000, CRC(3f3712fb) SHA1(bc960bec54c6cb9342a335b8d15f55a1fa2e230e) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.07", 0x200000, 0x80000, CRC(3ff0aaa7) SHA1(412d1dfe93d510fc92f91aeb4b4e1f17aa354acd) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.08", 0x280000, 0x80000, CRC(008d8e1e) SHA1(385ace30c3257f55188d0dcd08b84788c42a18c9) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.09", 0x300000, 0x80000, CRC(9642bc00) SHA1(f3d4a3ddad6773d728cbcdd01d1d15a2104de39e) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.10", 0x380000, 0x80000, CRC(56ac1a00) SHA1(23bd4a88d3b63d7f06c8130837b896f01ed52623) )

	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "sfz3mix.13", 0x0000000, 0x400000, CRC(65ab82b8) SHA1(71fb84d64eb74809ce072e5be587145ddaba692b) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.15", 0x0000002, 0x400000, CRC(ef8fbc0a) SHA1(2e4b27cc62f80c2e2a7d2e32ee98619b2e12b42e) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.17", 0x0000004, 0x400000, CRC(652b1493) SHA1(89e6e1f2fb8c85168c934093e5b053ad80f82d14) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.19", 0x0000006, 0x400000, CRC(0a1b38b9) SHA1(782e1a3b6c6e4be732420e449073571e7b140ccd) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.14", 0x1000000, 0x400000, CRC(62496779) SHA1(8534226cc1074097fce296ec1ab6e453f9a2b69d) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.16", 0x1000002, 0x400000, CRC(1e7aa3cb) SHA1(66bfe1d7897f9dfd02db0523e8296aa50f4cf8c5) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.18", 0x1000004, 0x400000, CRC(95e161ce) SHA1(ef863b415fe4f07f5acf1e5082378c7603d8e58c) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.20", 0x1000006, 0x400000, CRC(a6afdc2d) SHA1(6bfd7261246f19cc12364fe02ba090d456a482ce) , ROM_GROUPWORD | ROM_SKIP(6) )
...
GAME( 2022, sfz3mix,    sfa3,     cps2,      cps2_2p6b, cps2_state, init_cps2, ROT0, "Zero800", "Street Fighter Zero 3 (Mix 0.10)", MACHINE_SUPPORTS_SAVE )
