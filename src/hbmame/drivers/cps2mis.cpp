...
ROM_START( sfz3mix7 ) // 0.07
	...
	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "sfz3mix.13", 0x0000000, 0x400000, CRC(1b5fc5f9) SHA1(0790956b6a9ffbf2e7540931e4bf730aa57a2106) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.15", 0x0000002, 0x400000, CRC(4f9de2d9) SHA1(61de76e576297a7609738024c8fb4775b951b088) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.17", 0x0000004, 0x400000, CRC(1fdd472e) SHA1(1a9c2bdb5becb049626333ba99d962207fb4ac88) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.19", 0x0000006, 0x400000, CRC(646a311f) SHA1(7e6c848cc5679dbe0e78cf13f389a32a59aa8a16) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.14", 0x1000000, 0x400000, CRC(e96ce6cc) SHA1(47c21bd039821959a6b6bd81abbd7c2b33ea0576) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.16", 0x1000002, 0x400000, CRC(b15d2507) SHA1(cf6c067e73d638a71bd41751fd9f30adfe092cc7) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.18", 0x1000004, 0x400000, CRC(b52f88f3) SHA1(527168c0072d068ea9d7e68772b9196dd731e07c) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.20", 0x1000006, 0x400000, CRC(8c7b3fa3) SHA1(ff8a296819315ad725b3a92893f4e9abb4aebd74) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( sfz3mix ) // 0.08
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.03", 0x000000, 0x80000, CRC(dccb6f06) SHA1(35f3975954024edba1c524d266ac7cf41a264d59) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.04", 0x080000, 0x80000, CRC(8617a7c4) SHA1(b51f695f5e9a532ec303c086fc005e1771390835) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.05", 0x100000, 0x80000, CRC(0f9e0705) SHA1(de66d559d29aea8a9127c81d17c96a6f7bee892b) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.06", 0x180000, 0x80000, CRC(f328c438) SHA1(e8a237aa08b0cd93f5370ee90d919672fa454d68) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.07", 0x200000, 0x80000, CRC(5bf5ed94) SHA1(7bcb670c5788b689fc9c6cfc832247af40807bd5) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.08", 0x280000, 0x80000, CRC(f5d17042) SHA1(7f0aff92480f9516d9129411e2200fd3b2726ec5) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.09", 0x300000, 0x80000, CRC(0928ede4) SHA1(d643c559c869ab806c44576cdf5adf332147dcd1) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.10", 0x380000, 0x80000, CRC(0f369728) SHA1(fd99024a092bd941890431061187a1dc7de5cdfd) )
...
GAME( 2022, sfz3mix,    sfa3,     cps2,      cps2_2p6b, cps2_state, init_cps2, ROT0, "Zero800", "Street Fighter Zero 3 (Mix 0.08)", MACHINE_SUPPORTS_SAVE )
