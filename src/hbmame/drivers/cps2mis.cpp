...
***************************************************/
ROM_START( sf2prime ) // v0.3
	ROM_REGION( CODE_SIZE, "maincpu", ROMREGION_ERASEFF )
	ROM_LOAD16_WORD_SWAP( "c88pr.p1", 0x000000, 0x80000, CRC(fd845fd6) SHA1(ff949bebb37facff71bfe799053d901caa600779) )
	ROM_LOAD16_WORD_SWAP( "c88pr.p2", 0x080000, 0x80000, CRC(5fcdfebe) SHA1(99aac66532656b0e1f84c81ce419062162f9c592) )
	ROM_LOAD16_WORD_SWAP( "c88pr.p3", 0x100000, 0x80000, CRC(9339eb7b) SHA1(ca95d414677d0ecbdea0bafaceac5c7add858b2c) )
	ROM_LOAD16_WORD_SWAP( "c88pr.p4", 0x180000, 0x80000, CRC(67761d04) SHA1(2164f4f22c4a4d3426fcab4ee8de9c620c01dbb0) )

	ROM_REGION( 0x2000000, "gfx", 0 )
	ROM_LOAD64_WORD( "c88pr.c1",   0x0000000, 0x800000, CRC(7c6a35f7) SHA1(72ef68880c9bf97fabee70944381bc299cb02e5c) )
	ROM_LOAD64_WORD( "c88pr.c2",   0x0000002, 0x800000, CRC(7b35f3f7) SHA1(99c608055836f8469f567e15677c78337ba78426) )
	ROM_LOAD64_WORD( "c88pr.c3",   0x0000004, 0x800000, CRC(3852deb5) SHA1(94feed9ac08a310243892219737845e4e7e648a0) )
	ROM_LOAD64_WORD( "c88pr.c4",   0x0000006, 0x800000, CRC(0454efa8) SHA1(b56eed703951d1690ce5575376e279e679526979) )
...
GAME( 2025, sf2prime,   hsf2,     dead_cps2, cps2_2p6b, cps2_state, init_cps2, ROT0, "Zero800", "Street Fighter II': Prime (v0.3)", MACHINE_SUPPORTS_SAVE )
