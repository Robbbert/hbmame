...
ROM_START( dkongte )
	...
	ROM_REGION( 0x10000, "braze", 0 )
	ROM_LOAD( "d2k11.te",     0x00000, 0x10000, CRC(e7cb76ce) SHA1(bf442d3747e4a3ecf703876666f9a4064eeeac7d) )
...
ROM_START( dkspkyte )
	...
	ROM_REGION( 0x10000, "braze", 0 )
	ROM_LOAD( "d2k11.spte",   0x00000, 0x10000, CRC(9cd53a2d) SHA1(55924d53865dd32aba2c260389d9939d869b53c6) )
...
GAME( 2021, dkongte,   dkong, dk_braze,  dkongx,  dkong_state,  init_dkongx, ROT270, "Sock Master", "Donkey Kong Tournament Edition", MACHINE_SUPPORTS_SAVE )
...
GAME( 2021, dkspkyte,  dkong, dk_braze,  dkongx,  dkong_state,  init_dkongx, ROT270, "Sock Master", "Donkey Kong Spooky Tournament Edition", MACHINE_SUPPORTS_SAVE )
