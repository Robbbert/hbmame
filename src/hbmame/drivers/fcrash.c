...
ROM_START( fcrash )
	...
	ROM_FILL(0x2610, 1, 7)  // temporary patch to fix transitions HBMAME
...
ROM_START( kodb )
	...
	ROM_FILL( 0x952, 1, 7)  // temporary patch to fix transitions HBMAME
...
GAME( 1990, cawingb,   cawing,   cawingb, cawingbl,   cps_state, cawingbl,  ROT0,   "bootleg", "Carrier Air Wing (bootleg)", GAME_SUPPORTS_SAVE )
