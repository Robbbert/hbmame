...
// The FairyLand Story
GAME( 200?, flstoryjs01,  flstory,  flstory,      flstory,  flstory_state, empty_init, ROT180, "Unknown", "The FairyLand Story (Translation Chinese)(Japan)", MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
