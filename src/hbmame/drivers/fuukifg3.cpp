...
#include "../mame/fuuki/fuukifg3.cpp"

ROM_START( asurabld01 )
...
ROM_START( asurabld04 ) //asurabldl
	ROM_REGION( 0x200000, "maincpu", 0 )
...
GAME( 2009, asurabld01, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "Pipi899", "Asura Blade - Sword of Dynasty (Energy Mode Max, 2009-11-21)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, asurabld02, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "Yumeji", "Asura Blade - Sword of Dynasty (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, asurabld03, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "hack", "Asura Blade - Sword of Dynasty (Enhanced Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, asurabld04, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "hack", "Asura Blade - Sword of Dynasty (Simplified Edition, 2018-06-04)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, asurabus01, asurabus, fuuki32, asurabusa,fuuki32_state, empty_init, ROT0, "Yumeji", "Asura Buster (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, asurabus02, asurabus, fuuki32, asurabusa,fuuki32_state, empty_init, ROT0, "hack", "Asura Buster (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
