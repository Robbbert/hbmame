...
GAME( 1984, galaga84, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "hack", "Galaga '84", GAME_SUPPORTS_SAVE )
GAME( 1999, galaga99, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Jerky and Sil", "Galaga '99", GAME_SUPPORTS_SAVE )
GAME( 1981, galagab2, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "bootleg", "Galaga (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 1982, galagabl, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "bootleg", "Galaga (Namco 1982)", GAME_SUPPORTS_SAVE )
GAME( 1981, galagads, galaga,  galaga,   galagamw, galaga_state,  galaga,  ROT90, "hack", "Galaga (fast shoot)", GAME_SUPPORTS_SAVE )
GAME( 2000, galagaef, galaga,  galaga,   galagamw, galaga_state,  galaga,  ROT90, "Hack", "Galaga (Enduring Freedom)", GAME_SUPPORTS_SAVE )
GAME( 1981, galagaf,  galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Namco", "Galaga (Fast Shoot Hack)", GAME_SUPPORTS_SAVE )
GAME( 2007, galagap,  galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Don Hodges", "Galaga (patched)", GAME_SUPPORTS_SAVE )
GAME( 1981, galagix,  galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Grand Master Peter", "Galagix", GAME_SUPPORTS_SAVE )
GAME( 2002, galagost, galaga,  galagost, galaga,   galaga_state,  galaga,  ROT90, "Twisty", "Galaga Ghost (Set 1)", GAME_SUPPORTS_SAVE )
GAME( 2002, galagosb, galaga,  galagost, galaga,   galaga_state,  galaga,  ROT90, "Twisty", "Galaga Ghost (Set 2 - 20021128)", GAME_SUPPORTS_SAVE )
GAME( 1998, galaped,  galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Cary Barnhard", "Galapede (Fast Shoot)", GAME_SUPPORTS_SAVE )
GAME( 1998, galgaxin, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "T-Bone", "Galagalaxian", GAME_SUPPORTS_SAVE )
GAME( 1984, nebulbee, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "hack", "Nebulous Bee", GAME_SUPPORTS_SAVE )
GAME( 2000, terror,   galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Hack", "Terrorist", GAME_SUPPORTS_SAVE )
GAME( 2000, vgalaga,  galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Hack", "Vector Galaga", GAME_SUPPORTS_SAVE )
GAME( 2000, vgalagam, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Hack", "Vector Galaga Midway", GAME_SUPPORTS_SAVE )
GAME( 2000, vgalagaf, galaga,  galaga,   galaga,   galaga_state,  galaga,  ROT90, "Hack", "Vector Galaga Fast Shoot", GAME_SUPPORTS_SAVE )
GAME( 2002, battlesh, xevious, battles,  xevious,  xevious_state, battles, ROT90, "bootleg", "Battles 2002", GAME_SUPPORTS_SAVE )
GAME( 2005, gaous,    xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco (Hack)", "Gaous", GAME_SUPPORTS_SAVE )
GAME( 2002, sxvioush, xevious, xevious,  sxevious, xevious_state, xevious, ROT90, "Namco", "Super Xevious 2002", GAME_SUPPORTS_SAVE )
GAME( 2004, xeviblk,  xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco", "Xevious Black", GAME_SUPPORTS_SAVE )
GAME( 2002, xevious3, xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco", "Xevious 2003", GAME_SUPPORTS_SAVE )
GAME( 2004, xevious4, xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco", "Xevious 2004", GAME_SUPPORTS_SAVE )
GAME( 2004, xevious5, xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco", "Xevious 2005", GAME_SUPPORTS_SAVE )
GAME( 2002, xevioush, xevious, xevious,  xevious,  xevious_state, xevious, ROT90, "Namco", "Xevious 2002", GAME_SUPPORTS_SAVE )
GAME( 2001, xeviousp, xevious, xevious,  sxevious, xevious_state, xevious, ROT90, "bootleg", "Xevious Plus!", GAME_SUPPORTS_SAVE )
GAME( 2002, xviousah, xevious, xevious,  xeviousa, xevious_state, xevious, ROT90, "Namco (Atari license)", "Xevious 2002 (Atari set 1)", GAME_SUPPORTS_SAVE )
