...
HACK( 2002, kof2k2pur,   kof2002, neogeo_noslot, neogeo, neogeo_state,        neogeo,   ROT0, "Kawada7278", "Kof2002 (Boss Purple Kawada7278 Hack)(decrypted C)" , MACHINE_SUPPORTS_SAVE )
...
ROM_START( kof2k2plcs13 )
	...
	NEO_SFIX_128K( "265plbs13.s1", CRC(f22511dd) SHA1(0b79171d0245e2ed74e3b7916f7cfc27bd93f998) )
...
ROM_START( kof2k2plcs14 )
	...
	NEO_SFIX_128K( "265plbs14.s1", CRC(178fb835) SHA1(4ba99d5914a4c1d30cd0aacb23ae05ba636739cb) )
...
ROM_START( kof2k2plcs15 )
	...
	NEO_SFIX_128K( "265plbs15.s1", CRC(9b050a98) SHA1(e7a1a849863f607273294f7dc65c79a62aa55a0b) )
...
ROM_START( kof2k2plcs16 )
	...
	NEO_SFIX_128K( "265plbs16.s1", CRC(209bf046) SHA1(3e7ad6e2b4190386e0011bf63a48fc6bac2dde0d) )
...
ROM_START( kof2k2plcs17 )
	...
	NEO_SFIX_128K( "265plbs17.s1", CRC(52865270) SHA1(8702c37c62e64d6255734b83759b232752c3927c) )
...
ROM_START( kof2k2plcs18 )
	...
	NEO_SFIX_128K( "265plbs18.s1", CRC(f78a662c) SHA1(58c1caa4c78b51181f3a6c89dd22fec382afe326) )
...
ROM_START( kof2k2plcs19 )
	...
	NEO_SFIX_128K( "265plbs19.s1", CRC(15fae632) SHA1(14c5668d8ac1ea3295aa778abaa89f40c4abb74e) )
...
HACK( 200?, kof2002s14,     kof2002,  neogeo_noslot, neogeo, neogeo_state,  kof2002,   ROT0, "Bootleg",    "Kof2002 (Magic Plus II)(NGM-2650)(NGH-2650)" , MACHINE_SUPPORTS_SAVE )
...
HACK( 200?, kof2002ds07,    kof2002,  neogeo_noslot, neogeo, neogeo_state,  kof2002hb,  ROT0, "Bootleg",    "Kof2002 (Magic Plus)(decrypted C)", MACHINE_SUPPORTS_SAVE )
