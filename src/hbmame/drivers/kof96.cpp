...
HACK( 200?, kof96ep,   kof96,    neogeo_noslot, neogeo, neogeo_state, kof96ep,  ROT0, "bootleg", "Kof'96 (Bootleg / Hack)(NGM-214)", MACHINE_SUPPORTS_SAVE )
...
ROM_START( kof96s44 )
	...
	ROM_LOAD16_BYTE( "214h44.c3", 0x0800000, 0x800000, CRC(48d81318) SHA1(2c2f4149c613da45d8b2a8545ccef4ed3cfc0d74) )
	ROM_LOAD16_BYTE( "214h44.c4", 0x0800001, 0x800000, CRC(36a80f5b) SHA1(2ff9a3c583104b04debc5ea1ab49bc81907ac75e) )
	ROM_LOAD16_BYTE( "214h44.c5", 0x1000000, 0x800000, CRC(7390418c) SHA1(0fb1f294fe52ffe7b8525ec3eb7ba058c96d021f) )
	ROM_LOAD16_BYTE( "214h44.c6", 0x1000001, 0x800000, CRC(b45cb5ec) SHA1(9515b3a192755829ea1bb5a5955725fa7d253af2) )
ROM_END
...
ROM_START( kof96s45 )
	...
	ROM_LOAD16_BYTE( "214h44.c2", 0x0000001, 0x800000, CRC(6ff22256) SHA1(cc92838f83d01ff1bef5d354231c223043705170) )
	ROM_LOAD16_BYTE( "214h44.c3", 0x0800000, 0x800000, CRC(48d81318) SHA1(2c2f4149c613da45d8b2a8545ccef4ed3cfc0d74) )
	ROM_LOAD16_BYTE( "214h45.c4", 0x0800001, 0x800000, CRC(d69836e6) SHA1(30cdda1a72dfe536bced936c54145217fc6ae17f) )
	ROM_LOAD16_BYTE( "214h45.c5", 0x1000000, 0x800000, CRC(8bb710f2) SHA1(e0e673b712ce9baeee5980938bd7316ed2642379) )
	ROM_LOAD16_BYTE( "214h45.c6", 0x1000001, 0x800000, CRC(fc99d445) SHA1(ac7aaad07f5d310ab9c913d915a5d884731f4e3e) )
ROM_END
...
HACK( 200?, kof96s07,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (Remix Color + Power)(Set 02)(NGM-214)", MACHINE_SUPPORTS_SAVE )
...
HACK( 201?, kof96s29,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (Add Boss)(Chinese Edition)(NGM-214)", MACHINE_SUPPORTS_SAVE )
HACK( 201?, kof96s30,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Ydmis",    "Kof'96 (Remix V1)(Ver.?)(NGM-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s31,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Master Stiller",    "Kof'96 (Console Mode)(NGM-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s32,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Master Stiller",    "Kof'96 (Remix Special v1)(NGM-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s33,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Master Stiller",    "Kof'96 (Remix Special v2)(NGM-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s34,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Master Stiller",    "Kof'96 (Remix Special v3)(NGM-214)", MACHINE_SUPPORTS_SAVE )
...
HACK( 200?, kof96s41,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Eddids",    "Kof'96 (Add Boss Characters + Maximum Power)(NGH-214)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, kof96s42,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (Remix Special v4)(NGH-214)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, kof96s43,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (Remix Special v5)(NGH-214)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, kof96s44,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Master Stiller",    "Kof'96 (Remix Special v5)(?)(NGH-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s45,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (The Aniversary Edition 2018 2018-09-02)(NGH-214)", MACHINE_SUPPORTS_SAVE )
HACK( 2018, kof96s46,       kof96,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Unknown",    "Kof'96 (The Aniversary Edition 2019-02-15)(NGH-214)", MACHINE_SUPPORTS_SAVE )
