...
ROM_START( kof99s06 )
	...
	NEO_SFIX_128K( "251hc06.s1", CRC(8969b496) SHA1(2cbff513ce629437013ee6fbe42bcb3bd9a7b478) )
	...
	ROM_LOAD16_BYTE( "251d.c5",  0x2000000, 0x800000, CRC(9746268c) SHA1(59d839f01f4827377a752679922bc7281099430d) )
	ROM_LOAD16_BYTE( "251d.c6",  0x2000001, 0x800000, CRC(238b3e71) SHA1(f929c942972f768e68a5a009a3d174d203029160) )
	ROM_LOAD16_BYTE( "251hc06.c7",  0x3000000, 0x800000, CRC(0ac9f02e) SHA1(f6eb1d6c8a2aab26876f0526cb68f11607bdcc3a) )
	ROM_LOAD16_BYTE( "251hc06.c8",  0x3000001, 0x800000, CRC(a7e77d95) SHA1(70b3706d3371c7e07ae2b8ca1499eb35e4f95030) )
ROM_END
...
ROM_START( kof99s13 )
	...
	ROM_LOAD16_WORD_SWAP( "251hc13.p2", 0x100000, 0x400000, CRC(d8d74ec0) SHA1(769df8b5eb9ae648dc68d6bb84d8b52c2622a1e1) )

	NEO_SFIX_128K( "251hc13.s1", CRC(b676c8fe) SHA1(b15223fc44e93bde5bfbfa3bef978b05a7117b2b) )
...
ROM_START( kof99s14 )
	ROM_REGION( 0x500000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "251hc14.p1",  0x000000, 0x100000, CRC(6806bb9a) SHA1(83f52e72ea678d0d84f399a65211987a342c442f) )
...
ROM_START( kof99s22 )
	ROM_REGION( 0x500000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "251hc22.p1", 0x000000, 0x100000, CRC(cf1e98e7) SHA1(ec22ff296a3034d9227ccb95900136a93bd19bad) )
	ROM_LOAD16_WORD_SWAP( "251hc22.p2", 0x100000, 0x400000, CRC(f38fe174) SHA1(3d4bdd76d137fbec18e5e14ba22eb5a95abaddef) )
...
GAME( 1999, kof99s01,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 01)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s02,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 02)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s03,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 03)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s04,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 04)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s05,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 05)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s06,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 06)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s07,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 07)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s08,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 08)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s09,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 09)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s10,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 10)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s11,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 11)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s12,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 12)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s13,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 13)", MACHINE_IMPERFECT_SOUND | MACHINE_UNEMULATED_PROTECTION | MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
// GAME( 1999, kof99s14,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 14)", MACHINE_SUPPORTS_SAVE ) // Duplicado
GAME( 1999, kof99s15,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 15)", MACHINE_IMPERFECT_SOUND | MACHINE_UNEMULATED_PROTECTION | MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s16,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 16)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s17,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 17)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s18,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 18)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s19,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 19)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s20,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 20)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99s21,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 21)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
//GAME( 1999, kof99s22,       kof99,    neogeo_noslot, neogeo, neogeo_state,         neogeo,    ROT0, "Hacks",    "Kof'99 (Description Of Unknown Origin 22)", MACHINE_SUPPORTS_SAVE )//Duplicado
