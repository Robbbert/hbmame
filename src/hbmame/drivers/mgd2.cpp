...
GAME( 1993, 3countbd,  3countb,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "3 Count Bout (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, 2020bbd,   2020bb,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, alpham2d,  alpham2,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Alpha Mission II (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, androdund, androdun, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Visco", "Andro Dunos (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, aofd,      aof,      neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Art of Fighting (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, bakatonod, bakatono, neogeo_mj,       neogeo,   neogeo2_state, neogeo,   ROT0, "Monolith Corp.", "Bakatonosama Mahjong Manyuki (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, bstarsd,   bstars,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Baseball Stars Professional (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, burningfd, burningf, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Burning Fight (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, crswordd,  crsword,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co.", "Crossed Swords (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, cyberlipd, cyberlip, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Cyber-Lip (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, eightmand, eightman, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK / Pallas", "Eight Man (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, fatfury1d, fatfury1, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Fatal Fury - King of Fighters (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, fbfrenzyd, fbfrenzy, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Football Frenzy (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, gpilotsd,  gpilots,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Ghost Pilots (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, joyjoyd,   joyjoy,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Puzzled (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, kotmd,     kotm,     neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "King of the Monsters (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, lbowlingd, lbowling, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "League Bowling (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, lresortd,  lresort,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Last Resort (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, maglordd,  maglord,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co.", "Magician Lord (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, minasand,  minasan,  neogeo_mj,       neogeo,   neogeo2_state, neogeo,   ROT0, "Monolith Corp.", "Minnasanno Okagesamadesu (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, mutnatd,   mutnat,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Mutation Nation (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, ncombatd,  ncombat,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Combat (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, ncommandd, ncommand, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co", "Ninja Commando (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, ridherod,  ridhero,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Riding Hero (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, roboarmyd, roboarmy, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Robo Army (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, sengokud,  sengoku,  neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Sengoku (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, sengoku2d, sengoku2, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Sengoku 2 (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, socbrawld, socbrawl, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Soccer Brawl (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, superspyd, superspy, neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "The Super Spy (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, tpgolfd,   tpgolf,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "SNK", "Top Player's Golf (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, trallyd,   trally,   neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co.", "Thrash Rally (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, wh1d,      wh1,      neogeo_noslot,   neogeo,   neogeo2_state, neogeo,   ROT0, "Alpha Denshi Co.", "World Heroes (MGD2)", MACHINE_SUPPORTS_SAVE )
