...
GAME( 1981, mspacman, 0,        mspacman, mspacpls, pacman_state,  mspacman, ROT90, "Midway", "Ms. Pacman", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmat, mspacman, mspacman, mspacman, pacman_state,  mspacman, ROT90, "hack", "Ms. Pac Attack", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmab, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "bootleg", "Ms. Pacman (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmbe, mspacman, woodpek,  mspacman, pacman_state,  mspacmbe, ROT90, "bootleg", "Ms. Pacman (bootleg, (encrypted))", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmnf, mspacman, mspacman, mspacman, pacman_state,  mspacman, ROT90, "Midway", "Ms. Pacman (with speedup hack)", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacpls, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "hack", "Ms. Pacman Plus", GAME_SUPPORTS_SAVE )
...
GAME( 2000, ms2600,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman 2600", GAME_SUPPORTS_SAVE )
GAME( 2000, msbaby,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Baby Pacman", GAME_SUPPORTS_SAVE )
GAME( 2000, msmini,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pac-Mini", GAME_SUPPORTS_SAVE )
GAME( 2000, msminia,  mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "T-Bone", "Ms. Pac-Attack Mini [c]", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes4a,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman SNES (Tall Alternate)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes62,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman NES (Set 2)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes63,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman NES (Set 3)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes6m,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman NES (6 maps)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes6m2, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman SNES (New Mazes)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes6m3, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman SNES (Regular / Tall)", GAME_SUPPORTS_SAVE )
GAME( 2000, msnes6m4, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman SNES (Regular)", GAME_SUPPORTS_SAVE )
GAME( 1998, mspacnes, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman NES", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacren, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman Renaissance", GAME_SUPPORTS_SAVE )
GAME( 2000, mspc6mad, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Ms. Pacman After Dark (6 Mazes)", GAME_SUPPORTS_SAVE )
GAME( 2000, msvctr6m, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "T-Bone", "Vector Ms. Pacman (6 Mazes)", GAME_SUPPORTS_SAVE )

/* Jerronimo's Progs - www.umlautllama.com */

GAME( 2004, horizpab, mspacman, woodpek,  mspacman, driver_device, 0,        ROT0,  "Scott Lawrence", "Horiz Pac (v1.0)", GAME_SUPPORTS_SAVE )
...
GAME( 2001, msdroid,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Grendal74", "Ms. Pacman Android", GAME_SUPPORTS_SAVE )
GAME( 2001, msgrkatk, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "Grendal74", "Ms. Pac Attack Greek [c]", GAME_SUPPORTS_SAVE )
GAME( 2001, msgrkb,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Grendal74", "Ms. Pacman Greek", GAME_SUPPORTS_SAVE )

/* Medragon's Hacks */

GAME( 2000, mrpacman, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Tim Appleton", "Mr. Pacman - Another Kind of Role Reversal", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacfnt, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Tim Appleton", "Ms. Pacman with Pacman font", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacwf,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Tim Appleton", "Ms Weird Fruit Pac", GAME_SUPPORTS_SAVE )
GAME( 2000, msrumble, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Tim Appleton", "Ms. Pac Rumble", GAME_SUPPORTS_SAVE )

/* Sil's Hacks */

GAME( 2000, mselton,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Elton", GAME_SUPPORTS_SAVE )
GAME( 2000, msf1pac,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. F1 Pacman", GAME_SUPPORTS_SAVE )
GAME( 2000, msindy,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Indy", GAME_SUPPORTS_SAVE )
GAME( 1999, mspac6m,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Pacman 6M (Six Maze)", GAME_SUPPORTS_SAVE )
GAME( 1999, mspac6m2, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Pacman 6M (Six Maze) (Set 2)", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacad,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Pacman After Dark", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacat2, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "Marcel Silvius", "Ms. Pacman Plus / Attack [c]", GAME_SUPPORTS_SAVE )

/* Bobby Tribble's Hacks */

GAME( 2000, msberzk,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Bobby Tribble", "Ms. Pacman Berzerk", GAME_SUPPORTS_SAVE )

/* Hires hacks */

GAME( 1981, mspacatx, mspacmnx, mspacmnx, mspacpls, pacman_state, mspacman,  ROT90, "hack", "Ms. Pac Attack (hires hack)", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmbx, mspacmnx, woodpekx, mspacman, driver_device, 0,        ROT90, "bootleg", "Ms. Pac-Man (bootleg) (hires hack)", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmfx, mspacmnx, mspacmnx, mspacpls, pacman_state, mspacman,  ROT90, "Midway", "Ms. Pac-Man (hires hack) [f]", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacmnx, 0,        mspacmnx, mspacpls, pacman_state, mspacman,  ROT90, "Midway", "Ms. Pac-Man (hires hack)", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacplx, mspacmnx, woodpekx, mspacpls, driver_device, 0,        ROT90, "hack", "Ms. Pac-Man Plus (hires hack) [c]", GAME_SUPPORTS_SAVE )
GAME( 1981, pacgalx,  mspacmnx, woodpekx, mspacman, driver_device, 0,        ROT90, "hack", "Pac-Gal (hires hack)", GAME_SUPPORTS_SAVE )
...
GAME( 2000, fastmspa, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman [f]", GAME_SUPPORTS_SAVE )
GAME( 2000, faststrm, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Desert Storm [f]", GAME_SUPPORTS_SAVE )
GAME( 2000, fstmsatk, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Attack [f]", GAME_SUPPORTS_SAVE )
GAME( 2000, heartbn2, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "PacHack", "Ms. Heart Burn", GAME_SUPPORTS_SAVE )
GAME( 2000, heartbrn, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "TwoBit Score", "Ms. Heart Burn (set 2)", GAME_SUPPORTS_SAVE )
GAME( 2000, msatk2ad, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Plus / Attack After Dark [c]", GAME_SUPPORTS_SAVE )
GAME( 2000, msatkad,  mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Plus After Dark [c]", GAME_SUPPORTS_SAVE )
GAME( 2000, msdstorm, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Mike Naylor", "Ms. Desert Storm", GAME_SUPPORTS_SAVE )
GAME( 2000, mshangly, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Hangly Man", GAME_SUPPORTS_SAVE )
GAME( 2000, msheartb, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Hearts (set 2)", GAME_SUPPORTS_SAVE )
GAME( 2000, mshearts, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Hearts", GAME_SUPPORTS_SAVE )
GAME( 1981, mspac1,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman (single rom set 2)", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacatb, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Plus (Set B) [c]", GAME_SUPPORTS_SAVE )
GAME( 1980, mspacde,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman -1", GAME_SUPPORTS_SAVE )
GAME( 1998, mspacii,  mspacman, mspacii,  mspacman, driver_device, 0,        ROT90, "Orca", "Ms. Pacman II", GAME_SUPPORTS_SAVE )
GAME( 1983, mspacit,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman -2", GAME_SUPPORTS_SAVE )
GAME( 1983, mspacit2, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman -3", GAME_SUPPORTS_SAVE )
GAME( 1981, mspacj,   mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman (Jamma? Bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2007, mspacmap, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90,  "Don Hodges", "Ms. Pacman (patched)", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacmbg, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman (single rom)", GAME_SUPPORTS_SAVE )
GAME( 2006, mspacpbl, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "Dav/PMP", "Ms. Pac Plus (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacrip, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "R3mer", "Ms. Pac-Mortem", GAME_SUPPORTS_SAVE )
GAME( 2000, mspacsup, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Super Ms. Pac-Man", GAME_SUPPORTS_SAVE )
GAME( 2000, mssilad,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman After Dark (Sil)", GAME_SUPPORTS_SAVE )
GAME( 2000, msultra,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "PacFan", "Ms. Ultra Pacman", GAME_SUPPORTS_SAVE )
GAME( 2000, msvectr,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Vector Ms. Pacman", GAME_SUPPORTS_SAVE )
GAME( 2000, msyakman, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Jeff Minter", "Ms. Yak Man", GAME_SUPPORTS_SAVE )
GAME( 1982, pacgalu,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Uchida", "Pac-Gal (Hearts)", GAME_SUPPORTS_SAVE )
GAME( 2001, petshop,  mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "Weirdness Inc", "Pet Shop Freak-Out!", GAME_SUPPORTS_SAVE )
GAME( 2002, piranha2, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "US Billiards", "Piranha 2 Revenge!", GAME_SUPPORTS_SAVE )
GAME( 2000, sueworld, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "PacFay", "Sue's World", GAME_SUPPORTS_SAVE )
GAME( 2000, sueworlb, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "PacFay", "Sue's World (Old)", GAME_SUPPORTS_SAVE )
GAME( 19??, supmspac, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "Spedic Vending", "Super Ms Pac-man [f]", GAME_SUPPORTS_SAVE )
GAME( 2000, vectratk, mspacman, woodpek,  mspacpls, driver_device, 0,        ROT90, "[Midway]", "Vector Attack [c]", GAME_SUPPORTS_SAVE )
GAME( 2000, zolaad,   mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Super Zola Pac Gal After Dark", GAME_SUPPORTS_SAVE )
GAME( 2000, zolaatk,  mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Super Zola Pac Gal Attack", GAME_SUPPORTS_SAVE )
GAME( 2000, zolamaze, mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman No Exit", GAME_SUPPORTS_SAVE )
GAME( 2000, zolapac,  mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Super Zola Pac Gal", GAME_SUPPORTS_SAVE )
GAME( 2000, zolaslow, mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Super Zola Pac Gal (Slow)", GAME_SUPPORTS_SAVE )
GAME( 2000, zolatunl, mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Super Zola Pac Gal (Tunnels)", GAME_SUPPORTS_SAVE )
GAME( 2000, zolavect, mspacman, zolapac,  mspacman, driver_device, 0,        ROT90, "Tqwn Amusement", "Vector Super Zola Pac Gal", GAME_SUPPORTS_SAVE )
