...
GAME( 1995, csw2,     neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "ADK", "Crossed Swords 2", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 2011, b2b,      neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Visco / NCI", "Bang Bang Busters (prototype)", GAME_SUPPORTS_SAVE )
GAME( 1995, fr2,      neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Video Systems Co.", "Idol Mahjong Final Romance 2", GAME_SUPPORTS_SAVE )
GAME( 1995, fr2cd,    fr2,      neogeo,   neogeo,  neogeo_state, fr2ch,    ROT0, "Video Systems Co.", "Idol Mahjong Final Romance 2 (CD Bootleg)", GAME_SUPPORTS_SAVE )
GAME( 1995, fr2ch,    fr2,      neogeo,   neogeo,  neogeo_state, fr2ch,    ROT0, "Video Systems Co.", "Idol Mahjong Final Romance 2 (CD to MVS conversion)", GAME_SUPPORTS_SAVE )
GAME( 1996, zintrkcd, neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Razoola", "ZinTricK / Oshidashi Zentrix (CD Bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2011, totc,     neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Face / NCI", "Treasure of the Caribbean", GAME_SUPPORTS_SAVE )

GAME( 2002, beast,    neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Jeff Kurtz", "Shadow of the Beast (Neo Demo)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE )
GAME( 2006, cnbe,     neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Blastar", "Codename: Blut Engel", GAME_SUPPORTS_SAVE )
GAME( 2009, cndi,     neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "[Raregame]", "Chip n Dale Intro", GAME_SUPPORTS_SAVE )
GAME( 2013, cphd,     neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Le Cortex", "Crouching Pony Hidden Dragon Demo", GAME_SUPPORTS_SAVE )
GAME( 1990, columnsn, neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Jeff Kurtz", "Columns (Neo-Geo)", GAME_SUPPORTS_SAVE )
GAME( 2009, dwi,      neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "[Raregame]", "DarkWing Duck Intro", GAME_SUPPORTS_SAVE )
GAME( 2006, ffeast,   neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Rastersoft", "Frog Feast (NeoGeo)", GAME_SUPPORTS_SAVE )
GAME( 2005, ffeastd,  ffeast,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Rastersoft", "Frog Feast Demo", GAME_SUPPORTS_SAVE )
GAME( 2009, gbi,      neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "[Raregame]", "GhostBusters Intro", GAME_SUPPORTS_SAVE )
GAME( 2013, iocero,   neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Primo Demo", GAME_SUPPORTS_SAVE )
GAME( 2007, lhcdb,    neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "NG:Dev.Team", "Last Hope CD Beta", GAME_SUPPORTS_SAVE )
GAME( 2005, ltorb,    neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Blastar", "Jonas Indiana and The Lost Temple of RA (beta - 20050717)", GAME_SUPPORTS_SAVE )
GAME( 20??, knacki,   neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Furrtek", "KnackiBalls", GAME_SUPPORTS_SAVE )
GAME( 2004, neo2500,  neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Blastar", "Neo 2500 Demo", GAME_SUPPORTS_SAVE )
GAME( 2012, neo3d,    neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Oxygene", "Neo 3D Demo", GAME_SUPPORTS_SAVE )
GAME( 2004, neocstlv, neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BarfHappy", "Neo Castlevania Demo", GAME_SUPPORTS_SAVE )
GAME( 2003, neodemo,  neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Charles Doty", "Demo - NeoGeo", GAME_SUPPORTS_SAVE )
GAME( 2013, neogal1,  neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Neo Geo Galaga Demo R001", GAME_SUPPORTS_SAVE )
GAME( 2013, neogal1d, neogal1,  neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Neo Geo Galaga Demo R001 (debug)", GAME_SUPPORTS_SAVE )
GAME( 2013, neogal1t, neogal1,  neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Neo Geo Galaga Demo R001 (text)", GAME_SUPPORTS_SAVE )
GAME( 2013, neogal2,  neogal1,  neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Neo Geo Galaga Demo R002", GAME_SUPPORTS_SAVE )
GAME( 2002, neonopon, neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Blastar", "Neo No Panepon V0.2", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 2002, neopong,  neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "Neodev", "Neo Pong (v1.1)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE )
GAME( 2002, neoponga, neopong,  npong10,  neogeo,  neogeo_state, neogeo,   ROT0, "Neodev", "Neo Pong (v1.0)", GAME_SUPPORTS_SAVE )
GAME( 2010, neoromjb, neogeo,   neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "CeL", "Neo Rom Jukebox", GAME_SUPPORTS_SAVE )
GAME( 2013, neotest,  neogal1,  neogeo,   neogeo,  neogeo_state, neogeo,   ROT0, "BEY", "Neo Geo Sound Test", GAME_SUPPORTS_SAVE )
