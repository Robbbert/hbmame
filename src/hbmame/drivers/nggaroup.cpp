...
DRIVER_INIT_MEMBER( neogeo2_hbmame, garoud )
{
...
GAME( 1999, garoub,    garou,    neogeo_noslot, neogeo, neogeo2_state, garou,  ROT0, "Ydmis", "Garou - Mark of the Wolves (Boss hack by Ydmis)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoud,    garou,    neogeo_noslot, neogeo, neogeo2_hbmame,       garoud, ROT0, "hack","Garou - Mark of the Wolves (decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupamu, garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "MU", "Garou - Mark of the Wolves (proto) (Approach to Arcade by MU v5.0a)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupeh,  garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Ydmis", "Garou - Mark of the Wolves (proto) (Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupehc, garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Creamymami and Ydmis", "Garou - Mark of the Wolves (proto) (Add Char - Pow hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupf,   garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Unk", "Garou - Mark of the Wolves (proto) (Fixed winning message, sprites and some bugs)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupfu,  garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Unk", "Garou - Mark of the Wolves (proto) (Unk Hack/Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupfp,  garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Unk", "Garou - Mark of the Wolves (proto) (Rom Fix - FixPlus)", MACHINE_SUPPORTS_SAVE )
GAME( 2011, garoupx11, garoupy,  neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "hack", "Garou - Mark of the Wolves XTREME PLUS", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupy,   neogeo,   neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "Ydmis", "Garou - Mark of the Wolves (proto) (P1 Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoupy1,  garou,    neogeo_noslot, neogeo, neogeo2_state,        neogeo, ROT0, "hack", "Garou: Mark of the Wolves (Prototype) [Boss Hack by Ydmis]", MACHINE_SUPPORTS_SAVE )
...
GAME( 2017, garoups01,      garou,    neogeo_noslot, neogeo, neogeo2_state,         neogeo,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Description Of Unknown Origin 01)(prototype)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, garoups02,      garou,    neogeo_noslot, neogeo, neogeo2_state,         neogeo,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Description Of Unknown Origin 02)(prototype)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, garoups03,      garou,    neogeo_noslot, neogeo, neogeo2_state,  garou,     ROT0, "Hacks",    "Garou - Mark of the Wolves (Infinite Power)(NGM-2530)(prototype)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, garouhs01,      garou,    neogeo_noslot, neogeo, neogeo2_state,  garouh,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Enable Grant & Kain In Arcade Mode)(NGM-2530)(NGH-2530)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, garouhs02,      garou,    neogeo_noslot, neogeo, neogeo2_state,  garouh,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Get Maximum Power On A Valid Attack, Being Attacked Or On A Special move)(NGM-2530)(NGH-2530)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, garoupsi01,     garou,    neogeo_noslot, neogeo, neogeo2_state,         neogeo,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Enhanced Power V1)(prototype)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, garoupsi02,     garou,    neogeo_noslot, neogeo, neogeo2_state,         neogeo,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Easy Special Attacks)(prototype)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, garoupsi03,     garou,    neogeo_noslot, neogeo, neogeo2_state,         neogeo,    ROT0, "Hacks",    "Garou - Mark of the Wolves (Bug Patch v2)(prototype)", MACHINE_SUPPORTS_SAVE )
