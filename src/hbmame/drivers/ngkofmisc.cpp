...
DRIVER_INIT_MEMBER( neogeo_hbmame, kof10thu )
{
	...
	UINT8 *trom = machine().root_device().memregion( "user1" )->base();
	UINT32 i, ofst;
...
ROM_START( kof10thu ) 
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "5004-p1u.bin", 0x600000, 0x100000, CRC(dd135fb6) SHA1(4e85814a44ee9fee9760048dd6d6fd2b66521bb1) )
	ROM_CONTINUE( 0x100000, 0x500000 )
	ROM_CONTINUE( 0x000000, 0x100000 )
	ROM_CONTINUE( 0x700000, 0x100000 )

	ROM_REGION16_BE( 0x800000, "user1", ROMREGION_ERASE00 )
...
ROM_START( kof10thub )
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "5004-c1ud.bin", 0x0000000, 0x800000, CRC(2491af91) SHA1(e3e237e50395dc985c564867046ad202bc744d37) )
	ROM_LOAD16_BYTE( "5004-c2ud.bin", 0x0000001, 0x800000, CRC(47ff1d91) SHA1(7d6ade9409af2c64114ed5836ccf9f50c7ebac69) )
	ROM_LOAD16_BYTE( "k2k4s-c3.bin", 0x1000000, 0x800000, CRC(959fad0b) SHA1(63AB83DDC5F688DC8165A7FF8D262DF3FCD942A2) )
	ROM_LOAD16_BYTE( "k2k4s-c7.bin", 0x1000001, 0x800000, CRC(efe6a468) SHA1(2A414285E48AA948B5B0D4A9333BAB083B5FB853) )
	ROM_LOAD16_BYTE( "k2k4s-c2.bin", 0x2000000, 0x800000, CRC(74bba7c6) SHA1(E01ADC7A4633BC0951B9B4F09ABC07D728E9A2D9) )
	ROM_LOAD16_BYTE( "k2k4s-c6.bin", 0x2000001, 0x800000, CRC(e20d2216) SHA1(5D28EEA7B581E780B78F391A8179F1678EE0D9A5) )
...
ROM_START( kogd )
	...
	ROM_LOAD16_BYTE( "5232-c1d.c1d", 0x0000000, 0x800000, CRC(8E964A75) SHA1(e7611d7908ca056f4b3c0ae2c4da8f6809db4556) )
	ROM_LOAD16_BYTE( "5232-c2d.c2d", 0x0000001, 0x800000, CRC(D102DE17) SHA1(e98f33a4d16ebda6cf369b92480d4306c780cf8b) )
	...
	ROM_LOAD16_BYTE( "5232-c5d.c5d", 0x2000000, 0x400000, CRC(C2698BE3) SHA1(0b1d414549947f6c29ebc71057aef96634656f32) )
	ROM_LOAD16_BYTE( "5232-c6d.c6d", 0x2000001, 0x400000, CRC(B057DB30) SHA1(2f342f03848f3f553bc70b2dbee2cc388a344a06) )
ROM_END
...
GAME( 2004, kof2k4mp,   kof2002,  neogeo_noslot,     neogeo, neogeo_noslot_state,     kof2k4se,  ROT0, "hack", "Kof2004 Special Edition Magic PLUS", MACHINE_SUPPORTS_SAVE )
GAME( 2010, kof2k4ru,   kof2002,  neogeo_noslot,     neogeo, neogeo_state,            neogeo,    ROT0, "MVS Hacks PSP", "Kof2004 Remix Ultra 2.6F", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4se1,  kof2002,  neogeo_noslot,     neogeo, neogeo_noslot_state,     kof2k4se,  ROT0, "bootleg", "Kof2004 Special Edition (hack 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4seb,  kof2002,  neogeo_noslot,     neogeo, neogeo_state,            neogeo,    ROT0, "Dragon Co.", "Kof2004 Special Edition (portuguese edition)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4spl,  kof2002,  neogeo_noslot,     neogeo, neogeo_noslot_state,     kof2k4se,  ROT0, "bootleg", "Kof2004 Special Edition Plus", MACHINE_SUPPORTS_SAVE )
GAME( 2008, kof2k8uni,  kof2002,  neogeo_noslot,     neogeo, neogeo_state,            neogeo,    ROT0, "bootleg", "Kof 10th Anniversary 2008 Unique", MACHINE_SUPPORTS_SAVE )
...
GAME( 2005, kogd,       kof97,    hbmame_kog,        neogeo, neogeo_hbmame,           kogd,      ROT0, "bootleg", "King of Gladiator (fully decrypted)", MACHINE_SUPPORTS_SAVE )
...
///GAME( 2004, kf2k4pls,   kof2002,  neogeo_noslot,   neogeo, neogeo_state,   kf2k4pls, ROT0, "bootleg", "Kof2004 Special Edition Plus", MACHINE_SUPPORTS_SAVE )
///GAME( 2004, kof10thd,   kof2002,  neogeo_noslot,   neogeo, neogeo_state,   kof10thd, ROT0, "bootleg", "Kof 10th Anniversary (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
