...
GAME( 1993, 3countbd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "3 Count Bout (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, 2020bbd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, alpham2d,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Alpha Mission II (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, androdud,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Visco", "Andro Dunos (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, aofd,      neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Art of Fighting (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, bakatond,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Monolith Corp.", "Bakatonosama Mahjong Manyuki (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, bstarsd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Baseball Stars Professional (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, burningd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Burning Fight (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, crswordd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co.", "Crossed Swords (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, cyberlid,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Cyber-Lip (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, eightmad,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK / Pallas", "Eight Man (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, fatfuryd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Fatal Fury - King of Fighters (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, fbfrenzd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Football Frenzy (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, gpilotsd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Ghost Pilots (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, joyjoyd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Puzzled (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, kotmd,     neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "King of the Monsters (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, lbowlind,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "League Bowling (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, lresortd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Last Resort (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, maglordd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co.", "Magician Lord (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, minasand,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Monolith Corp.", "Minnasanno Okagesamadesu (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, mutnatd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Mutation Nation (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, ncombatd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Combat (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, ncommndd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co", "Ninja Commando (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, ridherod,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Riding Hero (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, roboarmd,  roboarmy, neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Robo Army (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, sengokud,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Sengoku (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, sengok2d,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Sengoku 2 (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, socbrawd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Soccer Brawl (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, superspd,  neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "The Super Spy (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, tpgolfd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "SNK", "Top Player's Golf (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, trallyd,   neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co.", "Thrash Rally (MGD2)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, wh1d,      neogeo,   neogeo,   neogeo,   neogeo_class, neogeo,   ROT0, "Alpha Denshi Co.", "World Heroes (MGD2)", MACHINE_SUPPORTS_SAVE )
