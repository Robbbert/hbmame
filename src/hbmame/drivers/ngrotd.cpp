...
ROM_START( rotds16 )
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "264hc16.c1", 0x0000000, 0x800000, CRC(52126204) SHA1(78af3f15233b4798978a5214382a8d91fa70f69c) )
	ROM_LOAD16_BYTE( "264hc16.c2", 0x0000001, 0x800000, CRC(58f79e13) SHA1(d1f01d46df9e79c7df2db6bf05740f2970a01ed4) )
	ROM_LOAD16_BYTE( "264hc16.c3", 0x1000000, 0x800000, CRC(30f8e775) SHA1(49671cbd27616130e2f11b7678052fc8e090937a) )
	ROM_LOAD16_BYTE( "264hc16.c4", 0x1000001, 0x800000, CRC(4c618f32) SHA1(b7ca14f908b71a381ce88024a9562b021c39d393) )
	ROM_LOAD16_BYTE( "264hc16.c5", 0x2000000, 0x800000, CRC(d5c59c25) SHA1(f7b409d93fdf4d1b2a87a49722853d77dc8fc67b) )
	ROM_LOAD16_BYTE( "264hc16.c6", 0x2000001, 0x800000, CRC(e3babe6a) SHA1(e61efa02a28f81fcfc4d76edc0ab4118126f3008) )
	ROM_LOAD16_BYTE( "264hc16.c7", 0x3000000, 0x800000, CRC(84bb00b6) SHA1(cdf3bf1843110057556683658827da818128e82b) )
	ROM_LOAD16_BYTE( "264hc16.c8", 0x3000001, 0x800000, CRC(eff2cd12) SHA1(cab417f8974780786b98637effad8a1a8c2e8562) )
ROM_END
...
GAME( 2017, rotds18,        rotd,     neogeo_noslot, neogeo, neogeo_state,  rotd,      ROT0, "Hacks",    "Rage of the Dragons (Super Remix Edition 1.0)(NGM-264?)", MACHINE_SUPPORTS_SAVE )
