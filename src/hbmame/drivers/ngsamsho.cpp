...
ROM_START( samsho2s19 )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "063s19.p1", 0x000000, 0x200000, CRC(106c38ce) SHA1(940cbbe80db6891c03681744a96d7d906c1c2790) )
...
ROM_START( samsho5s50 )
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ssvhc50.p2", 0x000000, 0x400000, CRC(F05852c5) SHA1(178d28d3f0264dab987d6e9283c971e61d3843d4) )
...
ROM_START( samsho5s67 )
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ssvhc50.p2", 0x000000, 0x400000, CRC(F05852c5) SHA1(178d28d3f0264dab987d6e9283c971e61d3843d4) )
	ROM_LOAD16_WORD_SWAP( "ssvhc67.p1", 0x400000, 0x400000, CRC(62b9b5f7) SHA1(9b91eb41a355ba3fcf81c9729b0401b2cb0e55f2) )
...
ROM_START( samsh5sp10 ) // samsho5spn p1,s1,v1,v2 confirmed
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "272sp10.p1", 0x000000, 0x800000, CRC(2dbd32dc) SHA1(595693e1e116f96dbe6e552565a4edb06f685a67) )
	...
	ROM_REGION( 0x1000000, "ymsnd", 0 )
	ROM_LOAD( "272sp10.v1", 0x000000, 0x800000, CRC(3bf61586) SHA1(270fd58781b2b897a7365ccdf878c7e57048da35) )
	ROM_LOAD( "272sp10.v2", 0x800000, 0x800000, CRC(95fe7646) SHA1(eec1a3a4dc5b5a960735147c29b976581a660628) )
...
GAME( 2016, samshos02,      samsho,   neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",    "Samurai Shodown (Max Power)(NGM-045)", MACHINE_SUPPORTS_SAVE )
GAME( 2016, samshos03,      samsho,   neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",    "Samurai Shodown (Claws To The max)(NGM-045)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2016, samshos06,      samsho,   neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",    "Samurai Shodown (Ex Enhanced Power V1)(NGM-045)", MACHINE_SUPPORTS_SAVE )
GAME( 2016, samshos07,      samsho,   neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",    "Samurai Shodown (Ex Enhanced Power V2)(NGM-045)", MACHINE_SUPPORTS_SAVE )
GAME( 2016, samshos08,      samsho,   neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",    "Samurai Shodown (Hidden Characters-Enable Hidden Characters)(NGM-045)", MACHINE_SUPPORTS_SAVE )
// Samurai Shodown II
...
GAME( 2017, samsho5s48,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b, ROT0,  "Hacks",    "Samurai Shodown V (Enable Hidden Characters V1)(bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s49,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b, ROT0,  "Hacks",    "Samurai Shodown V (Enable Hidden Characters V2)(bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s50,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b, ROT0,  "Hacks",    "Samurai Shodown V (Enable Hidden Characters V2A)(bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s51,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b, ROT0,  "Hacks",    "Samurai Shodown V (Nanatsu No Tachi)(bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s52,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b, ROT0,  "Hacks",    "Samurai Shodown V (Null Boundary Plus)(bootleg)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2017, samsho5s55,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Enable Hidden Characters V1)(Samsho5h)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s56,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Enable Hidden Characters V2 - Color Patch)(Samsho5h)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s57,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Null Boundary Plus)(Samsho5h)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s58,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Unlimited Credits In Console Mode)(Samsho5h)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s59,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5b,  ROT0,  "Hacks",    "Samurai Shodown V (Power Style)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s60,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Hidden Characters - Color Patch)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s61,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Hidden Characters - Poppy As Challenger Patch)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s62,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Added portraits For Yumeji, Sankuro And Gaoh Alt)(NGM-2700)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s63,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Hidden Characters - Color Patch Alt)(NGM-2700)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, samsho5s64,     samsho5,  neogeo_noslot, neogeo, neogeo_state,  samsho5,  ROT0,  "Hacks",    "Samurai Shodown V (Heihe Dream Road Move To Change)(NGM-2700)", MACHINE_SUPPORTS_SAVE )
