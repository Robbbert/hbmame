...
GAME( 2017, sengoku3s02,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (EX Super Version V1)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s03,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (EX Super Version V2)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s04,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (EX Super Version V3)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s05,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (EX Super Version V4)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s06,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (Unlock All Stages)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s07,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (Lock Combo Counter And Power)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s08,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (Color Modification V1)" , MACHINE_SUPPORTS_SAVE )
GAME( 2017, sengoku3s09,    sengoku3, neogeo_noslot, neogeo, neogeo_state,  sengoku3, ROT0,  "Hacks",    "Sengoku 3 (Color Modification V2)" , MACHINE_SUPPORTS_SAVE )
