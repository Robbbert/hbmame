...
ROM_START( svcplusas29 )
	...
	NEO_SFIX_MT_128K
	ROM_LOAD( "svc-s1pl.bin", 0x10000, 0x10000, CRC(233d6439) SHA1(369024c7a2405c3144c14ac016c07c3dc0f44187) )
	ROM_CONTINUE( 0x00000, 0x10000 )
...
HACK( 200?, svchs30,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown",    "SvC Chaos (Blue Remix Plus)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, svchs31,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown",    "SvC Chaos (Pink Remix Plus)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
HACK( 2003, svchs32,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown",    "SvC Chaos (Description Of Hack Unknown)(Set 01)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, svchs33,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown", "SvC Chaos (Description Of Hack Unknown)(Set 02)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, svchs34,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown", "SvC Chaos (Description Of Hack Unknown)(Set 03)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, svchs35,        svc,      neogeo_noslot, neogeo, neogeo_state,  svchb,    ROT0,  "Unknown", "SvC Chaos (Description Of Hack Unknown)(Set 04)(decrypted C set 1)", MACHINE_SUPPORTS_SAVE )
