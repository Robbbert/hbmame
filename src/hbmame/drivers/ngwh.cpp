...
ROM_START( wh2s01 ) // World Heroes 2 Jet old set that was in MAME
	ROM_REGION( 0x200000, "maincpu", 0 )
...
GAME( 1995, whps01,         whp,      neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes Perfect (Description Of Unknown Origin 01)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whps02,         whp,      neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whps03,         whp,      neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss Set 01)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whps04,         whp,      neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss Set 02)", MACHINE_SUPPORTS_SAVE )
 // World Heroes 2 Jet
GAME( 1992, wh1s01,        wh1,      neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes (Description Of Unknown Origin 01)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, wh2s01,         wh2j,     neogeo_noslot, neogeo, neogeo_state,         neogeo,   ROT0,  "Hacks",     "World Heroes 2 Jet (Description Of Unknown Origin 01)", MACHINE_SUPPORTS_SAVE )
