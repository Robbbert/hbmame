...
ROM_START( tdragon2p )
	...
	ROM_LOAD( "10.bpr", 0x0000, 0x0100, CRC(e6ead349) SHA1(6d81b1c0233580aa48f9718bade42d640e5ef3dd) )
ROM_END
...
ROM_START( powerins01 )
	...
	ROM_REGION( 0x0100, "nmk_irq:htiming", 0 )
	ROM_LOAD( "20.u54",       0x0000,   0x0100, CRC(38bd0e2f) SHA1(20d311869642cd96bb831fdf4a458e0d872f03eb) )

	ROM_REGION( 0x0100, "nmk_irq:vtiming", 0 )
	ROM_LOAD( "21.u71",       0x0000,   0x0100, CRC(182cd81f) SHA1(3a76bea81b34ea7ccf56044206721058aa5b03e6) )
...
//Power Instinct
GAME( 2015, powerins01,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "hack", "Power Instinct (Great Blood Temple Simplification, 2015-12-05)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, powerins02,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "hack", "Power Instinct (Unknown Hack, 2017-07-01)", MACHINE_SUPPORTS_SAVE )
GAME( 2006, powerins03,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "0 DAY-S", "Power Instinct (Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, powerins04,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "hack", "Power Instinct (Simplify Edition, 2018-06-04)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, powerins05,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "hack", "Power Instinct (Optimised Edition, 2020-05-15)", MACHINE_SUPPORTS_SAVE )
GAME( 2006, powerins06,     powerins, powerins,      powerins,   nmk16_state,   empty_init,  ROT0,  "Devilfox & BisonSAS", "Power Instinct (Brazilian, 2006-04-25)", MACHINE_SUPPORTS_SAVE )
