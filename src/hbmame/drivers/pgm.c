...
GAME( 1999, kovph14,    kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 14)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE ) // crashes in attract mode, but plays ok
...
// Note: kovsh3-16 all have encrypted p-rom, and most of the other altered roms haven't been coded in yet
