...
GAME( 2014, ketarr17,   ket,       pgm_arm_type1_cave, pgm,   pgm_arm_type1_state, ket,        ROT270, "trap15", "Ketsui: Kizuna Jigoku Tachi (2014/07/16 ARRANGE 1.7 VER)", GAME_IMPERFECT_SOUND | GAME_SUPPORTS_SAVE )
...
GAME( 1999, kovp2k7,    kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 1)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpl116,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 2)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpl948,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 3)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpls06,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 4)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpls93,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 5)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpls97,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 6)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpluslb,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 7)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpluslw,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 8)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpluspj,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 9)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusq,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 10)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovpluss8,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 11)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusx,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 12)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusbe,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 13)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusdz,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 14)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusti,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 15)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovplusup,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 16)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovshhack,  kovsh,     pgm_arm_type1,      kovsh, pgm_arm_type1_state, kovsh,      ROT0,   "Hack", "Knights of Valour Super Heroes / Sangoku Senki Super Heroes (hack set 1)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
//GAME( 1999, kovshpa,    kovsh,     pgm_arm_type1,      kovsh, pgm_arm_type1_state, kovsh,      ROT0,   "Hack", "Knights of Valour Super Heroes / Sangoku Senki Super Heroes (hack set 2)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 1999, kovshre,    kovsh,     pgm_arm_type1,      kovsh, pgm_arm_type1_state, kovsh,      ROT0,   "Hack", "Knights of Valour Super Heroes / Sangoku Senki Super Heroes (hack set 3)", GAME_SUPPORTS_SAVE )
