...
GAME( 1999, kovpl948,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 3)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kovpls06,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 4)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
...
GAME( 1999, kovpluslw,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 8)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
...
GAME( 1999, kovplusx,   kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 12)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kovplusbe,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 13)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kovplusdz,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 14)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 1999, kovplusti,  kovplus,   pgm_arm_type1_sim,  sango, pgm_arm_type1_state, kov,        ROT0,   "Hack", "Knights of Valour Plus (hack set 15)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
...
GAME( 1999, kovshhack,  kovsh,     pgm_arm_type1,      kovsh, pgm_arm_type1_state, kovsh,      ROT0,   "Hack", "Knights of Valour Super Heroes / Sangoku Senki Super Heroes (hack set 1)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
