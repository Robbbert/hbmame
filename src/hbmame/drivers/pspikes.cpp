...
#include "../mame/vsystem/pspikes.cpp"

/**************
 Karate Blazers
*****************/

ROM_START( karatblz01 ) //karatblza
	...
	ROM_LOAD32_WORD( "v3.u44", 0x200000, 0x020000, CRC(34bdead2) SHA1(99f9a8cac807fcd599db55d2dc624ed92a3862ef) )
	ROM_LOAD32_WORD( "u43",    0x000002, 0x100000, CRC(7b349e5d) SHA1(8590a328f403e2c697a8d698c08d4adaf01fff62) )
	ROM_LOAD32_WORD( "v4.u45", 0x200002, 0x020000, CRC(be4d487d) SHA1(6d19c91d0498c43017219f0c10f4845a51ccfa7f) )
...
// Karate Blazers
GAME( 2017, karatblz01,  karatblz, karatblz,   karatblz,  pspikes_banked_sound_state, empty_init,      ROT0,   "hack", "Karate Blazers (1V4 2017-09-30)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, karatblz02,  karatblz, karatblz,   karatblz,  pspikes_banked_sound_state, empty_init,      ROT0,   "Pipi899", "Karate Blazers (Super Version V1 2009-03-11)", MACHINE_SUPPORTS_SAVE )
