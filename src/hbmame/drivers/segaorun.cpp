...
ROM_START( outrunm )
	...
	ROM_LOAD16_BYTE( "music-epr-10380b.133", 0x000000, 0x10000, CRC(9bf1d4df) SHA1(4d4be736c25f0e2f60851d26150ed6807014466a) )
	ROM_LOAD16_BYTE( "music-epr-10382b.118", 0x000001, 0x10000, CRC(86f90666) SHA1(e6a40afdbd5390266e9b43073cb41ec38b01d67c) )
	ROM_LOAD16_BYTE( "music-epr-10381b.132", 0x020000, 0x10000, CRC(cbec3f7e) SHA1(094d23afccf52bd25ae9ae9fdb9087cf3ac41709) )
	ROM_LOAD16_BYTE( "music-epr-10383b.117", 0x020001, 0x10000, CRC(e3c5cdca) SHA1(629dac90615deb2f68368012d5c67442b93c39b3) )
	...
	ROM_LOAD( "music-epr-10187.88", 0x00000, 0x20000, CRC(9f89439e) SHA1(a7c7610327e91647b41d73635a87ef2b95eee698) )
	...
	ROM_LOAD( "opr-10189.70", 0x40000, 0x08000, CRC(01366b54) SHA1(f467a6b807694d5832a985f5381c170d24aaee4e) )
	ROM_RELOAD(               0x48000, 0x08000 )
	//ROM_LOAD( "opr-10188.71", 0x50000, 0x08000, CRC(bad30ad9) SHA1(f70dd3a6362c314adef313b064102f7a250401c8) ) // has bit 5 stuck high from factory
	//ROM_RELOAD(               0x58000, 0x08000 )
	ROM_LOAD( "opr-10188a.71", 0x50000, 0x08000, CRC(c2de09b2) SHA1(00777e08ad8eddd48fe58686d4d1db68a78d3d6f) ) // recovered data from sega development disk
	ROM_RELOAD(               0x58000, 0x08000 )
ROM_END
