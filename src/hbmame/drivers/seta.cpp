...
// The FairyLand Story
GAME( 1992, blandias01,   blandia,   blandia,   blandia,   seta_state,     init_blandia,   ROT0,   "Unknown",  "Blandia (Boss With Simple Attack Edition)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1992, blandias02,   blandia,   blandia,   blandia,   seta_state,     init_blandia,   ROT0,   "DDJ",  "Blandia (Choice Hidden Character)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1992, blandias03,   blandia,   blandia,   blandia,   seta_state,     init_blandia,   ROT0,   "DDJ",  "Blandia (Easy Move)", MACHINE_IMPERFECT_GRAPHICS )
// Mobile Suit Gundam
