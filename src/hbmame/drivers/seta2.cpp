...
// Guardians
GAME( 2018, grdianss01,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2018-05-05)", MACHINE_NO_COCKTAIL )
GAME( 2018, grdianss02,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2018-06-06)", MACHINE_NO_COCKTAIL )
GAME( 1995, grdianss03,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hooooook", "Guardians (Blood Blue Initial Lengthening)", MACHINE_NO_COCKTAIL )
GAME( 1995, grdianss04,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "KrysoFun", "Guardians (Super Version V1)", MACHINE_NO_COCKTAIL )
GAME( 2010, grdianss05,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "Ivex", "Guardians (Super Version V2, 2010-07-12)", MACHINE_NO_COCKTAIL )
GAME( 2010, grdianss06,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "Ivex", "Guardians (Super Version V3, 2010-07-13)", MACHINE_NO_COCKTAIL )
GAME( 2019, grdianss07,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "BinDi", "Guardians (Robust Version, 2019-01-11)", MACHINE_NO_COCKTAIL )
GAME( 2018, grdianss08,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2018-12-10)", MACHINE_NO_COCKTAIL )
GAME( 2018, grdianss09,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Plus, 2018-07-26)", MACHINE_NO_COCKTAIL )
GAME( 2019, grdianss10,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2019-04-15)", MACHINE_NO_COCKTAIL )
GAME( 2019, grdianss11,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2019-09-16)", MACHINE_NO_COCKTAIL )
GAME( 2019, grdianss12,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Robust Super Edition, 2019-07-25)", MACHINE_NO_COCKTAIL )
GAME( 2019, grdianss13,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Kerron Edition, 2019-08-17)",  MACHINE_NO_COCKTAIL )
GAME( 2020, grdianss14,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2020-02-15)", MACHINE_NO_COCKTAIL )
GAME( 2020, grdianss15,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2020-02-06)", MACHINE_NO_COCKTAIL )
GAME( 2020, grdianss16,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2020-04-01)", MACHINE_NO_COCKTAIL )
...
GAME( 2020, grdianss18,   grdians,        grdians,  grdians,  seta2_state,    empty_init,    ROT0,   "hack", "Guardians (Warriors Edition, 2020-08-19)", MACHINE_NO_COCKTAIL )
