...
// Snow Bros. - Nick & Tom
GAME( 200?, snowbross01,   snowbros,  snowbros,    snowbros, snowbros_state, empty_init, ROT0, "nianxu",   "Snow Bros (Ex Super Version)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, snowbross02,   snowbros,  snowbros,    snowbros, snowbros_state, empty_init, ROT0, "EMU_MAX",  "Snow Bros (Snowman Brothers Cure Version 2.6A)", MACHINE_SUPPORTS_SAVE )
