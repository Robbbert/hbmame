...
ROM_START( crimecb )
	ROM_REGION( 0x80000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "b99-07.40", 0x00000, 0x20000, CRC(ad3129a0) SHA1(d01f4a2bcbe89d7ecee687fd8032cbe5b52f7b58) )
	ROM_LOAD16_BYTE( "b99-05.29", 0x00001, 0x20000, CRC(6046c7e7) SHA1(9de2a526e476852cd8a4d3cd39d5360ccc42cd29) )
