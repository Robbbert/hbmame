...
MACHINE_CONFIG_START( timelimt_hbmame::timelimit )
	...
	MCFG_ADDRESSABLE_LATCH_Q0_OUT_CB(WRITELINE(*this, timelimt_hbmame, nmi_enable_w))
	MCFG_ADDRESSABLE_LATCH_Q2_OUT_CB(WRITELINE(*this, timelimt_hbmame, coin_lockout_w))
