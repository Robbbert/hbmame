...
ROM_START( doapp01 ) // 12 characters to choose from instead of 10
	...
	ROM_LOAD16_BYTE( "doapp120.s01", 0x0000000, 0x100000, CRC(3a8e9786) SHA1(8632bcba3ecd42c112885821792c78f7b0f51cd9) )
...
ROM_START( sfex01 )
	...
	ROM_LOAD( "sfe-05m_s01.3h", 0x0000000, 0x400000, CRC(ee9ab584) SHA1(82c31637d58fabf41a29bc55f2c23e97a13c6520) )
...
ROM_START( sfex2s01 )
	...
	ROM_LOAD( "ex2-05m_s01.3h", 0x0000000, 0x800000, CRC(b78cdfd2) SHA1(64b53a777af2c943b023011afe1919aba452a6d1) )
...
ROM_START( sfex2p01 )
	...
	ROM_REGION32_LE( 0x3000000, "bankedroms", 0 )
	ROM_LOAD( "x2p-05mp_s01.3h", 0x0000000, 0x800000, CRC(08e6a6f4) SHA1(b18bb531fade80a6639cd6202c6e490f8a3144bd) )
...
ROM_START( sfexp01 )
	...
	ROM_REGION32_LE( 0x2400000, "bankedroms", 0 )
	ROM_LOAD( "sfp-05m_s01.3h", 0x0000000, 0x400000, CRC(449cf487) SHA1(1bad501d328169e04dab371b669e2952541db408) )
