...
ROM_START( mhavocrv2 ) // doesn't say return to vax on-screen. Release date unknown.
	...
	ROM_REGION( 0x18000, "alpha", 0 )
	ROM_LOAD( "136025.916",   0x08000, 0x4000, CRC(8613f09b) SHA1(20befacfce4263a45b0674369d0e7de495fdc4fd) )
	ROM_LOAD( "136025.917",   0x0c000, 0x4000, CRC(21889079) SHA1(d1ad6d9fa1432912e376bca50ceeefac2bfd6ac3) )

	ROM_LOAD( "136025.915",   0x10000, 0x4000, CRC(39dc3ac1) SHA1(5be399340e6688b070f236768e2122f5f5a596fa) )
	ROM_LOAD( "136025.918",   0x14000, 0x4000, CRC(d60ff5bd) SHA1(eac5fd92eb9ed7f8efff6821037ef5156e0b765f) )
...
GAME( 20??, mhavocrv2, mhavoc, mhavocrv, mhavocrv, mhavoc_state, init_mhavocrv, ROT0, "hack (JMA)", "Major Havoc - Return to Vax 1.8", MACHINE_SUPPORTS_SAVE )
