...
ROM_START( hotdp )
	...
	ROM_REGION( 0x800000, "copro_data", 0 ) // TGPx4 program
	ROM_LOAD32_WORD("cop0.29",  0x000000, 0x200000, CRC(fc2380f5) SHA1(02a2f8bfc3915787f3aa9645de8a0af4450cea33) )
	ROM_LOAD32_WORD("cop1.30",  0x000002, 0x200000, CRC(e6ae8f3c) SHA1(9a2c3d3b305e4707f7691d6242ff1bf47d1ced10) )
	...
	ROM_LOAD32_WORD("tex1.27", 0x0000000, 0x400000, BAD_DUMP CRC(86ef3ee4) SHA1(8ad2aa98d94e9a4f1abb61a02aba95064e533a61) ) // ROM gives stable reads with sum D82C, while label have handwriten byte sum 28DA
	...
	ROM_REGION( 0x080000, "audiocpu", 0 ) // Sound program
	ROM_LOAD16_WORD_SWAP("sprg.31", 0x000000, 0x080000, CRC(30accd2e) SHA1(098f07feaa007647f86ea02ef5e1102859c5890a) )

	ROM_REGION16_BE( 0x800000, "samples", 0 ) // Samples
	ROM_LOAD16_WORD_SWAP("snd0.32", 0x000000, 0x200000, CRC(e0a8dd56) SHA1(c80abe8e7541946b7dd615da98aeb04170ebf91d) )
	ROM_LOAD16_WORD_SWAP("snd1.33", 0x200000, 0x200000, CRC(a517834f) SHA1(232ec02fedf259a6112dd04e8a6b3a7a1ba17786) )
	ROM_LOAD16_WORD_SWAP("snd2.34", 0x400000, 0x200000, CRC(f0c529bb) SHA1(3c8f3843e9719079d993206feb083305aa85b0fb) )
	ROM_LOAD16_WORD_SWAP("snd3.35", 0x600000, 0x200000, CRC(3ad48d53) SHA1(b17f513705217966bc224721b444957de66d74b4) )
ROM_END
