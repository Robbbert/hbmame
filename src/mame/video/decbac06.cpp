...
TILE_GET_INFO_MEMBER(deco_bac06_device::get_pf8x8_tile_info)
{
	...
	//u32 flags=(m_pf_control_0[0]&2) ? 0 : TILE_FLIPX; // HBMAME fix for decodemo 2019-02-27 - TILE_GET_INFO_MEMBER always returns 0 for m_pf_control_0[0] regardless of its real value
